import {
  ...
  X as F,
  Y as $,
} from "./client.435b5d9d.js";
import { h as V, L as B, c as W, a as N } from "./createOctokit.d24fd105.js";
function H(t) {
  let e,
    i,
    l,
  ...
  return {
    ...
    l(t) {
      ...
      var p = o(C);
      (O = m(p, $)), p.forEach(a), (T = n(f, "DT", {}));
      var b = o(T);
      (A = m(b, V)), b.forEach(a), (L = n(f, "DD", {}));
      var _ = o(L);
      (R = m(_, B)), (E = m(_, W)), _.forEach(a), f.forEach(a), this.h();
    },
    h() {
      b(i, "class", "no-underline svelte-1d3m0a"),
        b(i, "href", (h = t[1].url.startsWith("$") ? "#" : t[1].url)),
        b(d, "class", (M = _(`tag ${t[1].status}`) + " svelte-1d3m0a"));
    },
    m(t, s) {
      r(t, e, s),
        y(e, i),
...
function K(t) {
  let e,
    ...
    d = t[1],
    u = [];
  for (let e = 0; e < d.length; e += 1) u[e] = Q(q(t, d, e));
  return {
    c() {
      (e = s("h2")), (i = g(c)), (l = p());
    ...
    l(t) {
      e = n(t, "H2", { class: !0 });
      var s = o(e);
      (i = m(s, c)), s.forEach(a), (l = x(t));
      for (let e = 0; e < u.length; e += 1) u[e].l(t);
      (h = P()), this.h();
    },
    h() {
      b(e, "class", "svelte-18y4uo2");
    },
    m(t, s) {
    ...
    p(t, e) {
      if (2 & e) {
        ...
        for (d = t[1], i = 0; i < d.length; i += 1) {
          ...
          u[i]
            ? u[i].p(s, e)
            : ((u[i] = Q(s)), u[i].c(), u[i].m(h.parentNode, h));
        }
...
function Q(t) {
  let e,
    ...
    A = f.i18n.incidentReport.replace(/\$NUMBER/g, t[6].number) + "",
  ...
  return {
    ...
    l(t) {
      L && L.l(t), (e = x(t)), (i = n(t, "ARTICLE", { class: !0 }));
      var s = o(i);
      l = n(s, "DIV", { class: !0 });
      var r = o(l);
      h = n(r, "DIV", {});
    ...
    h() {
      b(k, "href", (D = `${f.path}/incident/${t[6].number}`)),
        b(M, "class", "f r"),
        b(l, "class", "f"),
        b(
          i,
...
function bt(t) {
  if (ht(t)) return t.map(bt);
  if (ct(t)) {
    const e = Object.create(null),
      i = Object.keys(t),
      s = i.length;
    let n = 0;
    for (; n < s; ++n) e[i[n]] = bt(t[i[n]]);
    return e;
  }
  return t;
}
...
function Mt(t, e, i) {
  ...
  ct(s) && ct(n)
    ? wt(s, n)
    : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = bt(n));
}
function kt(t, e) {
  const i = t.indexOf(".", e);
...
const Zt = (t) => 0 === t || 1 === t,
  Qt = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * Tt) / i),
  Jt = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * Tt) / i) + 1,
  te = {
    linear: (t) => t,
    easeInQuad: (t) => t * t,
    easeOutQuad: (t) => -t * (t - 2),
    ...
    easeInElastic: (t) => (Zt(t) ? t : Qt(t, 0.075, 0.3)),
    easeOutElastic: (t) => (Zt(t) ? t : Jt(t, 0.075, 0.3)),
    easeInOutElastic(t) {
      const e = 0.1125;
      return Zt(t)
        ? t
  ...
  ie = "0123456789ABCDEF",
  se = (t) => ie[15 & t],
  ne = (t) => ie[(240 & t) >> 4] + ie[15 & t],
  oe = (t) => (240 & t) >> 4 == (15 & t);
function ae(t) {
  var e = (function (t) {
    return oe(t.r) && oe(t.g) && oe(t.b) && oe(t.a);
  })(t)
    ? se
    : ne;
...
const le = (t, e, i) => Math.max(Math.min(t, i), e);
function he(t) {
  return le(re(2.55 * t), 0, 255);
}
function ce(t) {
  return le(re(255 * t), 0, 255);
}
function de(t) {
  return le(re(t / 2.55) / 100, 0, 1);
}
function ue(t) {
  return le(re(100 * t), 0, 100);
}
const fe = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
const ge = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
function pe(t, e, i) {
...
function _e(t, e, i, s) {
  return (Array.isArray(e) ? t(e[0], e[1], e[2]) : t(e, i, s)).map(ce);
}
function ye(t, e, i) {
  return _e(pe, t, e, i);
}
  ...
  return (
    Array.isArray(t)
      ? t.length >= 3 &&
        ...
        t.length > 3 && (e.a = ce(t[3])))
      : ((e = Ce(t, { r: 0, g: 0, b: 0, a: 1 })).a = ce(e.a)),
    e
  );
}
function Te(t) {
...
class Ae {
  ...
  hexString() {
    return this._valid ? ae(this._rgb) : this._rgb;
  }
  hslString() {
    return this._valid
      ? (function (t) {
...
const Re = (t) => t instanceof CanvasGradient || t instanceof CanvasPattern;
function Ee(t) {
  return Re(t) ? t : Le(t);
}
function Ie(t) {
  return Re(t) ? t : Le(t).saturate(0.5).darken(0.1).hexString();
}
...
function Ve(t, e, i) {
  return "string" == typeof e ? vt($e(t, e), i) : vt($e(t, ""), e);
}
var Be = new (class {
  constructor(t) {
    (this.animation = void 0),
      ...
      (this.hover = {}),
      (this.hoverBackgroundColor = (t, e) => Ie(e.backgroundColor)),
      (this.hoverBorderColor = (t, e) => Ie(e.borderColor)),
      (this.hoverColor = (t, e) => Ie(e.color)),
      (this.indexAxis = "x"),
...
function Ne(t, e, i, s) {
  ...
  let l, h, c, d, u;
  for (l = 0; l < r; l++)
    if (((d = i[l]), null != d && !0 !== ht(d))) a = We(t, n, o, a, d);
    else if (ht(d))
      for (h = 0, c = d.length; h < c; h++)
        (u = d[h]), null == u || ht(u) || (a = We(t, n, o, a, u));
  t.restore();
  const f = o.length / 2;
  if (f > i.length) {
...
const ti = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
  ei = new RegExp(
...
function ri(t, e) {
  ...
  const n = {
    ...
    lineHeight: ii(ft(t.lineHeight, e.lineHeight), i),
    size: i,
    style: s,
...
const di = (t, e, i) => ci(t, i, (s) => t[s][e] < i),
  ui = (t, e, i) => ci(t, i, (s) => t[s][e] >= i);
const fi = ["push", "pop", "shift", "splice", "unshift"];
function gi(t, e) {
  const i = t._chartjs;
  if (!i) return;
  const s = i.listeners,
...
function mi(t, e = [""], i = t, s, n = () => t[0]) {
  Pt(s) || (s = Pi("_fallback", t));
  const o = {
    ...
    get: (i, s) =>
      vi(i, s, () =>
        (function (t, e, i, s) {
          let n;
          for (const o of e)
            if (((n = Pi(_i(o, t), i)), Pt(n)))
              return yi(t, n) ? Si(i, s, t, n) : n;
        })(s, e, t, i)
      ),
...
function xi(t, e, i, s) {
  const n = {
    ...
    _stack: new Set(),
    _descriptors: bi(t, s),
    setContext: (e) => xi(t, e, i, s),
    override: (n) => xi(t.override(n), e, i, s),
  };
  return new Proxy(n, {
          ...
          ht(r) &&
            ...
            (r = (function (t, e, i, s) {
              ...
              if (Pt(o.index) && s(t)) e = e[o.index % e.length];
                ...
                for (const l of i) {
                  const i = Si(s, n, t, l);
                  e.push(xi(i, o, a && a[t], r));
                }
              }
              return e;
            })(e, r, t, a.isIndexable));
          yi(e, r) && (r = xi(r, n, o && o[e], a));
          return r;
        })(t, e, i)
      ),
...
const _i = (t, e) => (t ? t + Dt(e) : e),
  yi = (t, e) => ct(e) && "adapters" !== t;
function vi(t, e, i) {
...
const Mi = (t, e) => (!0 === t ? e : "string" == typeof t ? St(e, t) : void 0);
function ki(t, e, i, s) {
  for (const n of e) {
    const e = Mi(i, n);
    if (e) {
      t.add(e);
      const n = wi(e._fallback, i, e);
      if (Pt(n) && n !== i && n !== s) return n;
...
function Ii(t, e, i, s, n) {
  ...
  if (
    ...
    for (o = 0, a = t.length; o < a; ++o)
      (r = t[o]),
        (l = Li(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension)),
        (r.cp1x = l.previous.x),
        (r.cp1y = l.previous.y),
        (r.cp2x = l.next.x),
        (r.cp2y = l.next.y),
      ...
      for (i = 0, s = t.length; i < s; ++i)
        (a = o),
          ...
          o &&
            ((n = t[i]),
            a &&
              ((n.cp1x = Ei(n.cp1x, e.left, e.right)),
              (n.cp1y = Ei(n.cp1y, e.top, e.bottom))),
            r &&
              ((n.cp2x = Ei(n.cp2x, e.left, e.right)),
              (n.cp2y = Ei(n.cp2y, e.top, e.bottom))));
    })(t, i);
}
function zi() {
...
const Vi = (t) => window.getComputedStyle(t, null);
...
const Hi = (t) => Math.round(10 * t) / 10;
function ji(t, e, i, s) {
  const n = Vi(t),
    o = Wi(n, "margin"),
    a = $i(n.maxWidth, t, "clientWidth") || Lt,
    r = $i(n.maxHeight, t, "clientHeight") || Lt,
    l = (function (t, e, i) {
      let s, n;
      if (void 0 === e || void 0 === i) {
        ...
        if (o) {
          ...
          (e = t.width - l.width - r.width),
            ...
            (s = $i(a.maxWidth, o, "clientWidth")),
            (n = $i(a.maxHeight, o, "clientHeight"));
  ...
  return (
    ...
    (h = Hi(Math.min(h, a, l.maxWidth))),
    (c = Hi(Math.min(c, r, l.maxHeight))),
    h && !c && (c = Hi(h / 2)),
    { width: h, height: c }
  );
}
...
function Qi(t, e, i) {
  return (function (t, e) {
    ...
    let s = Zi.get(i);
    return s || ((s = new Intl.NumberFormat(t, e)), Zi.set(i, s)), s;
  })(e, i).format(t);
}
function Ji(t, e, i) {
  return t
...
function is(t) {
  return "angle" === t
    ? { between: Kt, compare: Xt, normalize: qt }
    : {
...
function ss({ start: t, end: e, count: i, loop: s, style: n }) {
  return {
    start: t % i,
    end: e % i,
    loop: s && (e - t + 1) % i == 0,
...
function ns(t, e, i) {
  ...
  const { property: s, start: n, end: o } = i,
    a = e.length,
    { compare: r, between: l, normalize: h } = is(s),
    { start: c, end: d, loop: u, style: f } = (function (t, e, i) {
      const { property: s, start: n, end: o } = i,
        { between: a, normalize: r } = is(s),
        l = e.length;
      let h,
        c,
    ...
    (m = e[t % a]),
      m.skip ||
        ...
        p !== x &&
          ...
          null !== _ &&
            v() &&
            (g.push(ss({ start: _, end: t, loop: u, count: a, style: f })),
            (_ = null)),
          (i = t),
          (x = p)));
  return (
    null !== _ && g.push(ss({ start: _, end: d, loop: u, count: a, style: f })),
    g
  );
}
function os(t, e) {
...
const cs = {
  ...
  color(t, e, i) {
    const s = Ee(t || "transparent"),
      n = s.valid && Ee(e || "transparent");
...
class ds {
  constructor(t, e, i, s) {
    const n = e[i];
    s = li([t.to, s, n, t.from]);
    const o = li([t.from, n, s]);
    (this._active = !0),
      (this._fn = t.fn || cs[t.type || typeof o]),
      (this._easing = te[t.easing] || te.linear),
  ...
  update(t, e, i) {
    if (this._active) {
      ...
      (this._start = i),
        ...
        (this._total += n),
        (this._loop = !!t.loop),
        (this._to = li([t.to, e, s, t.from])),
        (this._from = li([t.from, s, e]));
    }
  }
  cancel() {
    this._active &&
...
const us = Object.keys(Be.animation);
Be.describe("animation", {
  _fallback: !1,
  _indexable: !1,
  ...
  Be.describe("animations", { _fallback: "animation" }),
  Be.set("transitions", {
...
class fs {
  ...
  update(t, e) {
    ...
    return i.length ? (hs.add(this._chart, i), !0) : void 0;
  }
}
function gs(t, e) {
  const i = (t && t.options) || {},
...
function ms(t, e, i, s = {}) {
  ...
  if (null !== e) {
    for (a = 0, r = n.length; a < r; ++a) {
      ...
      (h = t.values[l]), dt(h) && (o || 0 === e || $t(e) === $t(h)) && (e += h);
    }
    return e;
  }
}
...
function ys(t, e) {
  ...
  for (let t = 0; t < d; ++t) {
    const i = e[t],
      { [l]: o, [h]: d } = i;
    (u = (i._stacks || (i._stacks = {}))[h] = bs(n, c, o)),
      (u[r] = d),
...
const Ms = (t) => "reset" === t || "none" === t,
  ks = (t, e) => (e ? t : Object.assign({}, t));
class Ss {
  constructor(t, e) {
    (this.chart = t),
      (this._ctx = t.ctx),
  ...
  linkScales() {
    const t = this.chart,
      ...
      n = (e.xAxisID = ft(i.xAxisID, vs(t, "x"))),
      o = (e.yAxisID = ft(i.yAxisID, vs(t, "y"))),
      a = (e.rAxisID = ft(i.rAxisID, vs(t, "r"))),
      r = e.indexAxis,
  ...
  _destroy() {
    const t = this._cachedMeta;
    this._data && gi(this._data, this), t._stacked && ws(t);
  }
  _dataCheck() {
  ...
  buildOrUpdateElements(t) {
    ...
    (e._stacked = xs(e.vScale, e)),
      ...
      (s || n !== e._stacked) && ys(this, e._parsed);
  }
  configure() {
  ...
  applyStack(t, e, i) {
    const s = this.chart,
      n = this._cachedMeta,
      o = e[t.axis];
    return ms({ keys: ps(s, !0), values: e._stacks[t.axis] }, o, n.index, {
      mode: i,
    });
  }
  ...
  getMinMax(t, e) {
    const i = this._cachedMeta,
      ...
      r = ((t, e, i) =>
        t && !e.hidden && e._stacked && { keys: ps(i, !0), values: null })(
        e,
        i,
        this.chart
      ),
  ...
  _resolveElementOptions(t, e = "default", i) {
    ...
    return f.$shared && ((f.$shared = r), (n[o] = Object.freeze(ks(f, r)))), f;
  }
  _resolveAnimations(t, e, i) {
    ...
    const l = new fs(s, r && r.animations);
  ...
  updateElement(t, e, i, s) {
    Ms(s) ? Object.assign(t, i) : this._resolveAnimations(e, s).update(t, i);
  }
  ...
  const e = t.iScale,
    i = (function (t, e) {
      if (!t._cache.$bar) {
        ...
        t._cache.$bar = pi(s.sort((t, e) => t - e));
      }
      return t._cache.$bar;
    })(e, t.type);
  let s,
...
(Ss.defaults = {}),
  (Ss.prototype.datasetElementType = null),
  (Ss.prototype.dataElementType = null);
class Es extends Ss {
  parsePrimitiveData(t, e, i, s) {
    return Cs(t, e, i, s);
  }
    ...
    for (let c = e; c < e + i; c++) {
      const e = this.getParsed(c),
        ...
        p = {
          ...
          base: i.base,
          enableBorderRadius:
            !g || Os(e._custom) || o === g._top || o === g._bottom,
          x: l ? i.head : f.center,
          y: l ? f.center : i.head,
      ...
      Ts(p, m, g, o), Rs(p, m, h.ratio), this.updateElement(t[c], c, p, s);
    }
  }
  _getStacks(t, e) {
  ...
  _calculateBarValuePixels(t) {
    ...
    if (
      ...
      const t = ($t(c) * e.getLineWidthForValue(o)) / 2;
      (p += t), (c -= t);
    }
...
class zs extends Ss {
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta,
      i = this.chart,
      s = i.data.labels || [],
      n = Qi(e._parsed[t], i.options.locale);
      ...
      if (t._sorted) {
        ...
        d &&
          (n = Gt(
            Math.min(
              di(r, a.axis, h).lo,
              i ? s : di(e, l, a.getPixelForValue(h)).lo
            ),
            0,
            s - 1
          )),
          (o = u
            ? Gt(
                Math.max(
                  di(r, a.axis, c).hi + 1,
                  i ? 0 : di(e, l, a.getPixelForValue(c)).hi + 1
                ),
                n,
                s
              ) - n
...
class $s extends Ss {
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta,
      i = this.chart,
      s = i.data.labels || [],
      n = Qi(e._parsed[t].r, i.options.locale);
    return { label: s[t] || "", value: n };
  }
  update(t) {
    const e = this._cachedMeta.data;
  ...
  _computeAngle(t, e, i) {
    return this.chart.getDataVisibility(t)
      ? Ht(this.resolveDataElementOptions(t, e).angle || i)
      : 0;
  }
}
($s.id = "polarArea"),
...
(Bs.id = "radar"),
  ...
  (Bs.overrides = { aspectRatio: 1, scales: { r: { type: "radialLinear" } } });
class Ws extends Fs {}
(Ws.id = "scatter"),
  (Ws.defaults = { showLine: !1, fill: !1 }),
  (Ws.overrides = {
...
var Ns = Object.freeze({
  ...
  BarController: Es,
  BubbleController: Is,
  DoughnutController: zs,
  LineController: Fs,
  PolarAreaController: $s,
  PieController: Vs,
  RadarController: Bs,
...
var Ys = { _date: js };
function Us(t, e) {
  return "native" in t ? { x: t.x, y: t.y } : Ni(t, e);
}
function Xs(t, e, i, s) {
  const { controller: n, data: o, _sorted: a } = t,
    r = n._cachedMeta.iScale;
  if (r && e === r.axis && a && o.length) {
    const t = r._reversePixels ? ui : di;
    if (!s) return t(o, e, i);
    if (n._sharedOptions) {
      const s = o[0],
...
function Ks(t, e, i, s) {
  const n = [];
  if (!Ue(e, t.chartArea, t._minPadding)) return n;
  return (
    qs(
      t,
      i,
...
function Gs(t, e, i, s, n) {
  ...
  let a = Number.POSITIVE_INFINITY,
    r = [];
  if (!Ue(e, t.chartArea, t._minPadding)) return r;
  return (
    qs(t, i, e, function (i, l, h) {
      if (s && !i.inRange(e.x, e.y, n)) return;
      const c = i.getCenterPoint(n);
      if (!Ue(c, t.chartArea, t._minPadding) && !i.inRange(e.x, e.y, n)) return;
      const d = o(e, c);
      d < a
...
var Qs = {
  modes: {
    index(t, e, i, s) {
      const n = Us(e, t),
        o = i.axis || "x",
        a = i.intersect ? Ks(t, n, o, s) : Gs(t, n, o, !1, s),
        r = [];
      return a.length
    ...
    dataset(t, e, i, s) {
      const n = Us(e, t),
        o = i.axis || "xy";
      let a = i.intersect ? Ks(t, n, o, s) : Gs(t, n, o, !1, s);
      if (a.length > 0) {
    ...
    point: (t, e, i, s) => Ks(t, Us(e, t), i.axis || "xy", s),
    nearest: (t, e, i, s) => Gs(t, Us(e, t), i.axis || "xy", i.intersect, s),
    x: (t, e, i, s) => ((i.axis = "x"), Zs(t, e, i, s)),
    y: (t, e, i, s) => ((i.axis = "y"), Zs(t, e, i, s)),
  },
};
...
function en(t, e) {
  return t.filter((t) => -1 === Js.indexOf(t.pos) && t.box.axis === e);
}
function sn(t, e) {
  return t.sort((t, i) => {
    const s = e ? i : t,
...
function rn(t, e, i, s) {
  ...
  const r = Math.max(0, e.outerWidth - on(a, t, "left", "right")),
    l = Math.max(0, e.outerHeight - on(a, t, "top", "bottom")),
    h = r !== t.w,
    c = l !== t.h;
  return (
    (t.w = r),
...
function hn(t, e, i, s) {
  ...
  for (o = 0, a = t.length, h = 0; o < a; ++o) {
    (r = t[o]),
      (l = r.box),
      l.update(r.width || e.w, r.height || e.h, ln(r.horizontal, e));
    const { same: a, other: d } = rn(e, i, r, s);
    (h |= a && n.length), (c = c || d), l.fullSize || n.push(r);
  }
  return (h && hn(n, e, i, s)) || c;
}
  ...
  for (const r of t) {
    ...
    if (r.horizontal) {
      ...
      Pt(l.start) && (a = l.start),
        t.fullSize
          ? cn(t, n.left, a, i.outerWidth - n.right - n.left, o)
          : cn(t, e.left + l.placed, a, s, o),
        (l.start = a),
        (l.placed += s),
        (a = t.bottom);
    } else {
      ...
      Pt(l.start) && (o = l.start),
        t.fullSize
          ? cn(t, o, n.top, a, i.outerHeight - n.bottom - n.top)
          : cn(t, o, e.top + l.placed, a, s),
        (l.start = o),
        (l.placed += s),
        (o = t.right);
    }
...
var un = {
  ...
  update(t, e, i, s) {
    if (!t) return;
    const n = ai(t.options.layout.padding),
    ...
    hn(r.fullSize, f, d, g),
      ...
      dn(r.leftAndTop, f, d, g),
      (f.x += f.w),
      (f.y += f.h),
      dn(r.rightAndBottom, f, d, g),
      (t.chartArea = {
        left: f.left,
        top: f.top,
        right: f.left + f.w,
...
const pn = {
  ...
  mn = (t) => null === t || "" === t;
const xn = !!Ui && { passive: !0 };
function bn(t, e, i) {
  t.canvas.removeEventListener(e, i, xn);
}
function _n(t, e, i) {
  const s = t.canvas,
    n = new MutationObserver((t) => {
      for (const e of t)
        for (const t of e.addedNodes) if (t === s || t.contains(s)) return i();
    });
...
function kn(t, e, i) {
  ...
  return (
    a.observe(n),
    (function (t, e) {
      vn.size || window.addEventListener("resize", Mn), vn.set(t, e);
    })(t, o),
    a
  );
}
function Sn(t, e, i) {
  i && i.disconnect(),
    "resize" === e &&
      (function (t) {
        vn.delete(t), vn.size || window.removeEventListener("resize", Mn);
      })(t);
}
function Dn(t, e, i) {
  const s = t.canvas,
...
class Pn extends fn {
  ...
  addEventListener(t, e, i) {
    ...
    const s = t.$proxies || (t.$proxies = {}),
      n = { attach: _n, detach: yn, resize: kn }[e] || Dn;
    s[e] = n(t, e, i);
  }
  removeEventListener(t, e) {
    const i = t.$proxies || (t.$proxies = {}),
      s = i[e];
    if (!s) return;
    (({ attach: Sn, detach: Sn, resize: Sn }[e] || bn)(t, e, s),
      (i[e] = void 0));
  }
  getDevicePixelRatio() {
...
(Cn.defaults = {}), (Cn.defaultRoutes = void 0);
const On = {
  values: (t) => (ht(t) ? t : "" + t),
  numeric(t, e, i) {
    if (0 === t) return "0";
    ...
    return Object.assign(l, this.options.ticks.format), Qi(t, s, l);
  },
  logarithmic(t, e, i) {
    if (0 === t) return "0";
    const s = t / Math.pow(10, Math.floor(Ft(t)));
    return 1 === s || 2 === s || 5 === s ? On.numeric.call(this, t, e, i) : "";
  },
};
var Tn = { formatters: On };
function An(t, e) {
  ...
  if (o > 0) {
    ...
    for (Ln(e, l, h, lt(s) ? 0 : a - s, a), t = 0, i = o - 1; t < i; t++)
      Ln(e, l, h, n[t], n[t + 1]);
    return Ln(e, l, h, r, lt(s) ? e.length : r + s), l;
  }
  return Ln(e, l, h), l;
}
...
Be.set("scale", {
  ...
  Be.route("scale.ticks", "color", "", "color"),
  Be.route("scale.grid", "color", "", "borderColor"),
  Be.route("scale.grid", "borderColor", "", "borderColor"),
  Be.route("scale.title", "color", "", "color"),
  Be.describe("scale", {
    _fallback: !1,
    _scriptable: (t) =>
      !t.startsWith("before") &&
  ...
  Be.describe("scales", { _fallback: "scale" }),
  Be.describe("scale.ticks", {
    _scriptable: (t) => "backdropPadding" !== t && "callback" !== t,
    _indexable: (t) => "backdropPadding" !== t,
  });
const Rn = (t, e, i) => ("top" === e || "left" === e ? t[e] + i : t[e] - i);
function En(t, e) {
  const i = [],
    s = t.length / e,
    n = t.length;
...
class Vn extends Cn {
  ...
  update(t, e, i) {
    ...
    this._convertTicksToLabels(r ? En(this.ticks, a) : this.ticks),
      this.configure(),
      ...
      o.display &&
        ...
        ((this.ticks = An(this, this.ticks)), (this._labelSizes = null)),
  ...
  calculateLabelRotation() {
    ...
    const h = this._getLabelSizes(),
      c = h.widest.width,
      d = h.highest.height,
      u = Gt(this.chart.width - c, 0, this.maxWidth);
    (o = t.offset ? this.maxWidth / i : u / (i - 1)),
      c + 6 > o &&
        ...
        (l = jt(
          Math.min(
            Math.asin(Gt((h.highest.height + 6) / o, -1, 1)),
            Math.asin(Gt(a / r, -1, 1)) - Math.asin(Gt(d / r, -1, 1))
          )
        )),
  ...
  fit() {
    const t = { width: 0, height: 0 },
      ...
      a = this.isHorizontal();
    if (o) {
      const o = Fn(s, e.options.font);
      if (
        (a
          ? ((t.width = this.maxWidth), (t.height = zn(n) + o))
          : ((t.height = this.maxHeight), (t.width = zn(n) + o)),
      ...
      if (
        ...
        if (ht(h))
          for (r = 0, l = h.length; r < l; ++r)
            (m = h[r]),
              lt(m) || ht(m) || ((g = We(i, u.data, u.gc, g, m)), (p += f));
      } else (g = We(i, u.data, u.gc, g, h)), (p = f);
  ...
  getPixelForDecimal(t) {
    ...
    return Gt(this._alignToPixels ? He(this.chart, e, 0) : e, -32768, 32767);
  }
    ...
    if (t >= 0 && t < e.length) {
      ...
      return (
        ...
        (i.$context = (function (t, e, i) {
          return hi(t, { tick: i, index: e, type: "tick" });
        })(this.getContext(), t, i))
      );
    }
    return (
      this.$context ||
      (this.$context = hi(this.chart.getContext(), {
        scale: this,
        type: "scale",
      }))
    );
  ...
  _getXAxisLabelAlignment() {
    ...
    if (-Ht(this.labelRotation)) return "top" === t ? "left" : "right";
    let i = "center";
    return (
  ...
  drawBorder() {
    ...
    let r, l, h, c;
    this.isHorizontal()
      ? ((r = He(t, this.left, n) - n / 2),
        (l = He(t, this.right, o) + o / 2),
        (h = c = a))
      : ((h = He(t, this.top, n) - n / 2),
        (c = He(t, this.bottom, o) + o / 2),
        (r = l = a)),
      e.save(),
  ...
  _resolveTickFontOptions(t) {
    return ri(this.options.ticks.setContext(this.getContext(t)).font);
  }
  _maxDigits() {
...
class Bn {
  ...
  unregister(t) {
    const e = this.items,
      ...
      s = this.scope;
    i in e && delete e[i],
      s && i in Be[s] && (delete Be[s][i], this.override && delete ze[i]);
  }
}
var Wn = new (class {
  constructor() {
    (this.controllers = new Bn(Ss, "datasets", !0)),
      (this.elements = new Bn(Cn, "elements")),
      (this.plugins = new Bn(Object, "plugins")),
      (this.scales = new Bn(Vn, "scales")),
    ...
    return !1 !== s || e
      ? (function (t, e, i, s) {
          ...
          for (let a = 0; a < e.length; a++) {
            const r = e[a],
              l = Hn(i[r.id], s);
            null !== l && n.push({ plugin: r, options: jn(t.config, r, l, o) });
          }
          return n;
        })(t, n, s, e)
      : [];
    ...
    (e.scales = (function (t, e) {
      ...
      return (
        ...
        Object.keys(a).forEach((t) => {
          const e = a[t];
          wt(e, [Be.scales[e.type], Be.scale]);
        }),
        a
      );
    })(t, e));
...
function Zn(t, e) {
  let i = Kn.get(t);
  return i || ((i = e()), Kn.set(t, i), Gn.add(i)), i;
}
const Qn = (t, e, i) => {
  const s = St(e, i);
  void 0 !== s && t.add(s);
...
class Jn {
  ...
  getOptionScopes(t, e, i) {
    ...
    const r = new Set();
    e.forEach((e) => {
      t && (r.add(t), e.forEach((e) => Qn(r, t, e))),
        e.forEach((t) => Qn(r, s, t)),
        e.forEach((t) => Qn(r, ze[n] || {}, t)),
        e.forEach((t) => Qn(r, Be, t)),
        e.forEach((t) => Qn(r, Fe, t));
    });
  ...
  chartOptionScopes() {
    ...
    return [t, ze[e] || {}, Be.datasets[e] || {}, { type: e }, Be, Fe];
  }
  resolveNamedOptions(t, e, i, s = [""]) {
    const n = { $shared: !0 },
      { resolver: o, subPrefixes: a } = to(this._resolverCache, t, s);
    let r = o;
    if (
      (function (t, e) {
        const { isScriptable: i, isIndexable: s } = bi(t);
        for (const n of e) {
          const e = i(n),
            o = s(n),
            a = (o || e) && t[n];
          if ((e && (Ct(a) || eo(a))) || (o && ht(a))) return !0;
        }
        return !1;
      })(o, e)
    ) {
      n.$shared = !1;
      r = xi(o, (i = Ct(i) ? i() : i), this.createResolver(t, i, a));
    }
    for (const t of e) n[t] = r[t];
    return n;
  }
  createResolver(t, e, i = [""], s) {
    const { resolver: n } = to(this._resolverCache, t, i);
    return ct(e) ? xi(n, e, void 0, s) : n;
  }
}
function to(t, e, i) {
  let s = t.get(e);
...
const io = ["top", "bottom", "left", "right", "chartArea"];
function so(t, e) {
...
class co {
  constructor(t, e) {
    ...
    (this.id = rt()),
      ...
      (lo[this.id] = this),
      a && r
        ? (hs.listen(this, "complete", oo),
          hs.listen(this, "progress", ao),
          this._initialize(),
    ...
    e &&
      ...
      mt(n, (e) => {
        const n = e.options,
          ...
          a = Un(o, n),
          r = ft(n.type, e.dtype);
        (void 0 !== n.position && so(n.position, a) === so(e.dposition)) ||
  ...
  buildOrUpdateControllers() {
    ...
    for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
      ...
      if (
        ...
        (n.type = o),
        (n.indexAxis = s.indexAxis || Yn(o, this.options)),
        (n.order = s.order || 0),
        (n.index = i),
        (n.label = "" + s.label),
        ...
        const e = Wn.getController(o),
          { datasetElementType: s, dataElementType: a } = Be.datasets[o];
        Object.assign(e.prototype, {
          dataElementType: Wn.getElement(a),
          datasetElementType: s && Wn.getElement(s),
        }),
  ...
  render() {
    !1 !== this.notifyPlugins("beforeRender", { cancelable: !0 }) &&
      (hs.has(this)
        ? this.attached && !hs.running(this) && hs.start(this)
        : (this.draw(), oo({ chart: this })));
  }
  draw() {
    let t;
  ...
  getContext() {
    return (
      this.$context ||
      (this.$context = hi(null, { chart: this, type: "chart" }))
    );
  }
  ...
  _stop() {
    let t, e;
    for (
      this.stop(), hs.remove(this), t = 0, e = this.data.datasets.length;
      t < e;
      ++t
    )
  ...
  setActiveElements(t) {
    ...
    !xt(i, e) && ((this._active = i), this._updateHoverStyles(i, e));
  }
  notifyPlugins(t, e, i) {
  ...
  _handleEvent(t, e) {
    ...
    return (
      ...
      Ue(t, this.chartArea, this._minPadding) &&
        (pt(s.onHover, [t, a, this], this),
        ("mouseup" !== t.type &&
          "click" !== t.type &&
          "contextmenu" !== t.type) ||
          pt(s.onClick, [t, a, this], this)),
      (r = !xt(a, i)),
...
const uo = () => mt(co.instances, (t) => t._plugins.invalidate());
function fo(t, e, i) {
  const {
    startAngle: s,
    pixelMargin: n,
...
function go(t, e, i, s) {
  const n = si(t.options.borderRadius, [
    "outerStart",
    "outerEnd",
    "innerStart",
    "innerEnd",
  ...
  const o = (i - e) / 2,
    ...
    r = (t) => {
      ...
      return Gt(t, 0, Math.min(o, e));
    };
  return {
    outerStart: r(n.outerStart),
    outerEnd: r(n.outerEnd),
    innerStart: Gt(n.innerStart, 0, a),
    innerEnd: Gt(n.innerEnd, 0, a),
  };
}
function po(t, e, i, s) {
...
function mo(t, e, i, s, n) {
  ...
  const g = (f - Math.max(0.001, f * c - i / Ot) / c) / 2,
    p = r + g + u,
    m = n - g - u,
    { outerStart: x, outerEnd: b, innerStart: _, innerEnd: y } = go(
      e,
      d,
      c,
      m - p
  ...
  if ((t.arc(o, a, d, m - y / d, p + _ / d, !0), _ > 0)) {
    const e = po(S, P, o, a);
    t.arc(e.x, e.y, _, P + Math.PI, p - Et);
  }
  const T = po(v, p, o, a);
  if ((t.lineTo(T.x, T.y), x > 0)) {
    const e = po(v, M, o, a);
    t.arc(e.x, e.y, x, p - Et, M);
  }
  t.closePath();
}
...
Object.defineProperties(co, {
  defaults: { enumerable: true, value: Be },
  instances: { enumerable: true, value: lo },
  overrides: { enumerable: true, value: ze },
  registry: { enumerable: true, value: Wn },
  version: { enumerable: true, value: "3.6.0" },
  getChart: { enumerable: true, value: ho },
  register: {
    enumerable: true,
    value: (...t) => {
      Wn.add(...t), uo();
...
class bo extends Cn {
  ...
  inRange(t, e, i) {
    const s = this.getProps(["x", "y"], i),
      { angle: n, distance: o } = (function (t, e) {
        ...
        return o < -0.5 * Ot && (o += Tt), { angle: o, distance: n };
      })(s, { x: t, y: e }),
      {
        startAngle: a,
        endAngle: r,
    ...
    return (c >= Tt || Kt(n, a, r)) && o >= l + d && o <= h + d;
  }
  getCenterPoint(t) {
    const {
        x: e,
  ...
  draw(t) {
    ...
    const a = (function (t, e, i, s) {
      ...
      return mo(t, e, i, s, r), t.fill(), r;
    })(t, this, o, n);
    xo(t, this, o, n, a), t.restore();
  }
}
function _o(t, e, i = e) {
...
function wo(t, e, i, s) {
  const { points: n, options: o } = e,
    { count: a, start: r, loop: l, ilen: h } = vo(n, i, s),
    c = (function (t) {
      return t.stepped
        ? Ke
...
function Mo(t, e, i, s) {
  const n = e.points,
    { count: o, start: a, ilen: r } = vo(n, i, s),
...
(bo.id = "arc"),
  ...
  (bo.defaultRoutes = { backgroundColor: "backgroundColor" });
...
class Po extends Cn {
  ...
  updateControlPoints(t, e) {
    ...
    if (
      ...
      Ii(this._points, i, t, s, e), (this._pointsUpdated = !0);
    }
  }
  set points(t) {
    (this._points = t),
  ...
  interpolate(t, e) {
    const i = this.options,
      s = t[e],
      n = this.points,
      o = os(this, { property: e, start: s, end: s });
    if (!o.length) return;
    const a = [],
      r = (function (t) {
        return t.stepped
  ...
  draw(t, e, i, s) {
    ...
    (this.points || []).length &&
      n.borderWidth &&
      (t.save(), Do(t, this, i, s), t.restore()),
  ...
  beforeElementsUpdate: (t, e, i) => {
    ...
    t.data.datasets.forEach((e, n) => {
      const { _data: o, indexAxis: a } = e,
        ...
        l = o || e.data;
      if ("y" === li([a, t.options.indexAxis])) return;
      ...
      let { start: c, count: d } = (function (t, e) {
        ...
        return (
          l && (n = Gt(di(e, o.axis, a).lo, 0, i - 1)),
          (s = h ? Gt(di(e, o.axis, r).hi + 1, n, i) - n : i - n),
          { start: n, count: s }
        );
      })(r, l);
      if (d <= (i.threshold || 4 * s)) return void $o(e);
      let u;
      switch (
        (lt(o) &&
          ((e._data = l),
...
function Xo(t) {
  ...
  if ("stack" === i)
    return (function (t) {
      ...
      r.push(qo({ x: null, y: e.bottom }, s));
      for (let t = 0; t < o.length; t++) {
        const e = o[t];
        for (let t = e.start; t <= e.end; t++) Yo(n, a[t], r);
      }
      return new Po({ points: n, options: {} });
    })(t);
  if ("shape" === i) return !0;
  const n = Ho(t);
  return n instanceof No ? n : qo(n, s);
}
function qo(t, e) {
  let i = [],
    s = !1;
  return (
    ...
    i.length
      ? new Po({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s })
      : null
  );
}
function Ko(t, e, i) {
...
function ea(t, e) {
  const { line: i, target: s, property: n, color: o, scale: a } = e,
    r = (function (t, e, i) {
      ...
      for (const t of s) {
        ...
        const h = os(e, l);
        for (const e of h) {
          const s = Zo(i, o[e.start], o[e.end], e.loop),
            r = ns(t, n, s);
          for (const t of r)
            a.push({
              source: t,
  ...
  for (const { source: e, target: l, start: h, end: c } of r) {
    const { style: { backgroundColor: r = o } = {} } = e,
      d = !0 !== s;
    t.save(), (t.fillStyle = r), Jo(t, a, d && Zo(n, h, c)), t.beginPath();
    const u = !!i.pathSegment(t, e);
    let f;
    if (d) {
      u ? t.closePath() : ta(t, s, c, n);
    ...
    (function (t, e) {
      ...
      t.save(),
        "x" === l &&
          o !== n &&
          (Go(t, s, a.top),
          ea(t, { line: i, target: s, color: n, scale: r, property: l }),
          t.restore(),
          t.save(),
          Go(t, s, a.bottom)),
        ea(t, { line: i, target: s, color: o, scale: r, property: l }),
        t.restore();
    })(t, {
      line: n,
      target: s,
  ...
  afterDatasetsUpdate(t, e, i) {
    ...
    for (a = 0; a < s; ++a)
      (o = t.getDatasetMeta(a)),
        ...
        n.push(l);
    for (a = 0; a < s; ++a)
      (l = n[a]), l && !1 !== l.fill && (l.fill = Ko(n, a, i.propagate));
  },
  beforeDraw(t, e, i) {
    ...
    for (let e = n.length - 1; e >= 0; --e) {
      const i = n[e].$filler;
      i && (i.line.updateControlPoints(o, i.axis), s && ia(t.ctx, i, o));
    }
  },
...
class oa extends Cn {
  ...
  fit() {
    ...
    const i = t.labels,
      ...
      { boxWidth: a, itemHeight: r } = na(i, n);
    let l, h;
    (e.font = s.string),
      this.isHorizontal()
  ...
  _draw() {
    const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this,
      { align: n, labels: o } = t,
      a = Be.color,
      r = Ji(t.rtl, this.left, this.width),
      l = ri(o.font),
      { color: h, padding: c } = o,
      d = l.size,
      u = d / 2;
    ...
    this.drawTitle(),
      ...
      (s.lineWidth = 0.5),
      (s.font = l.string);
    const { boxWidth: g, boxHeight: p, itemHeight: m } = na(o, d),
      x = this.isHorizontal(),
    ...
    (f = x
      ...
      : {
          x: this.left + c,
          y: ot(n, this.top + b + c, this.bottom - e[0].height),
          line: 0,
        }),
  ...
  drawTitle() {
    const t = this.options,
      ...
      s = ai(e.padding);
    if (!e.display) return;
    const n = Ji(t.rtl, this.left, this.width),
      o = this.ctx,
      a = e.position,
      r = i.size / 2,
      l = s.top + r;
...
var aa = {
  ...
  _element: oa,
  start(t, e, i) {
    const s = (t.legend = new oa({ ctx: t.ctx, options: i, chart: t }));
    un.configure(t, s, i), un.addBox(t, s);
  },
  stop(t) {
  ...
  beforeUpdate(t, e, i) {
    const s = t.legend;
    un.configure(t, s, i), (s.options = i);
  },
  afterUpdate(t) {
    const e = t.legend;
...
class ra extends Cn {
  ...
  update(t, e) {
    ...
    this._padding = ai(i.padding);
    const n = s * ri(i.font).lineHeight + this._padding.height;
  ...
  _drawArgs(t) {
    ...
    return (
      this.isHorizontal()
        ...
        : ("left" === o.position
            ? ((l = i + t), (h = ot(a, s, e)), (c = -0.5 * Ot))
            : ((l = n - t), (h = ot(a, e, s)), (c = 0.5 * Ot)),
          (r = s - e)),
...
var la = {
  ...
  start(t, e, i) {
    !(function (t, e) {
      const i = new ra({ ctx: t.ctx, options: e, chart: t });
...
var ca = {
  id: "subtitle",
  start(t, e, i) {
    const s = new ra({ ctx: t.ctx, options: i, chart: t });
    un.configure(t, s, i), un.addBox(t, s), ha.set(t, s);
  },
  stop(t) {
    un.removeBox(t, ha.get(t)), ha.delete(t);
  },
  beforeUpdate(t, e, i) {
    const s = ha.get(t);
    un.configure(t, s, i), (s.options = i);
...
function xa(t, e, i) {
  ...
  return { xAlign: e.xAlign || ma(t, e, i, s), yAlign: s };
}
function ba(t, e, i, s) {
  const { caretSize: n, caretPadding: o, cornerRadius: a } = t,
    { xAlign: r, yAlign: l } = i,
    h = n + o,
    { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = oi(a);
  let g = (function (t, e) {
    let { x: i, width: s } = t;
  ...
  return (
    ...
    { x: Gt(g, 0, s.width - e.width), y: Gt(p, 0, s.height - e.height) }
  );
}
function _a(t, e, i) {
  const s = ai(i.padding);
  return "center" === e
    ? t.x + t.width / 2
    : "right" === e
    ? t.x + t.width - s.right
...
class wa extends Cn {
  ...
  getContext() {
    return (
      ...
      (this.$context =
        ...
        hi(t, { tooltip: e, tooltipItems: i, type: "tooltip" })))
    );
    var t, e, i;
  }
  getTitle(t, e) {
    ...
    let a = [];
    return (a = ua(a, fa(s))), (a = ua(a, fa(n))), (a = ua(a, fa(o))), a;
  }
  getBeforeBody(t, e) {
    return ya(e.callbacks.beforeBody.apply(this, [t]));
  }
  getBody(t, e) {
    const { callbacks: i } = e,
      s = [];
    return (
      mt(t, (t) => {
        const e = { before: [], lines: [], after: [] },
          n = va(i, t);
        ua(e.before, fa(n.beforeLabel.call(this, t))),
          ua(e.lines, n.label.call(this, t)),
          ua(e.after, fa(n.afterLabel.call(this, t))),
          s.push(e);
      }),
      s
    );
  ...
  getAfterBody(t, e) {
    return ya(e.callbacks.afterBody.apply(this, [t]));
  }
  getFooter(t, e) {
    const { callbacks: i } = e,
  ...
  _createItems(t) {
    ...
    let a,
      r,
      l = [];
    for (a = 0, r = e.length; a < r; ++a) l.push(ga(this._chart, e[a]));
    return (
      t.filter && (l = l.filter((e, s, n) => t.filter(e, s, n, i))),
      t.itemSort && (l = l.sort((e, s) => t.itemSort(e, s, i))),
      mt(l, (e) => {
        const i = va(t.callbacks, e);
  ...
  update(t, e) {
    ...
    if (s.length) {
      ...
      const e = (this._size = pa(this, i)),
        a = Object.assign({}, t, e),
        r = xa(this._chart, i, a),
        l = ba(i, a, r, this._chart);
    ...
    (this._tooltipItems = o),
      ...
      t &&
        i.external &&
        i.external.call(this, { chart: this._chart, tooltip: this, replay: e });
  }
  drawCaret(t, e, i, s) {
  ...
  getCaretPosition(t, e, i) {
    const { xAlign: s, yAlign: n } = this,
      ...
      { topLeft: r, topRight: l, bottomLeft: h, bottomRight: c } = oi(a),
      { x: d, y: u } = t,
      { width: f, height: g } = e;
    let p, m, x, b, _, y;
    return (
  ...
  drawTitle(t, e, i) {
    ...
    let o, a, r;
    if (n) {
      const l = Ji(i.rtl, this.x, this.width);
      for (
        t.x = _a(this, i.titleAlign, i),
  ...
  _drawColorBox(t, e, i, s, n) {
    ...
    if (n.usePointStyle) {
      ...
      Object.values(a).some((t) => 0 !== t)
        ? (t.beginPath(),
          (t.fillStyle = n.multiKeyBackground),
          Je(t, { x: e, y: g, w: l, h: r, radius: a }),
          t.fill(),
          t.stroke(),
          (t.fillStyle = o.backgroundColor),
          t.beginPath(),
          Je(t, { x: i, y: g + 1, w: l - 2, h: r - 2, radius: a }),
          t.fill())
        : ((t.fillStyle = n.multiKeyBackground),
          t.fillRect(e, g, l, r),
  ...
  drawBody(t, e, i) {
    ...
    let d = c.lineHeight,
      u = 0;
    const f = Ji(i.rtl, this.x, this.width),
      g = function (i) {
  ...
  drawFooter(t, e, i) {
    ...
    let o, a;
    if (n) {
      const r = Ji(i.rtl, this.x, this.width);
      for (
        t.x = _a(this, i.footerAlign, i),
  ...
  drawBackground(t, e, i, s) {
    const { xAlign: n, yAlign: o } = this,
      { x: a, y: r } = t,
      { width: l, height: h } = i,
      { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = oi(
        s.cornerRadius
      );
...
var Ma = {
    ...
    positioners: da,
    afterInit(t, e, i) {
      i && (t.tooltip = new wa({ _chart: t, options: i }));
    },
    beforeUpdate(t, e, i) {
...
class Da extends Vn {
  ...
  parse(t, e) {
    ...
    return ((t, e) => (null === t ? null : Gt(Math.round(t), 0, e)))(
      (e = isFinite(e) && i[e] === t ? e : Sa(i, t, ft(e, t))),
      i.length - 1
    );
  }
  determineDataLimits() {
...
function Pa(t, e) {
  ...
  for (
    ...
    (d && v !== o
      ? (i.push({ value: o }),
        v < o && D++,
        Wt(Math.round((v + D * k) * y) / y, o, Ca(o, _, t)) && D++)
      : v < o && D++);
    D < M;
    ++D
  )
  ...
  return (
    x && d && w !== a
      ? i.length && Wt(i[i.length - 1].value, a, Ca(a, _, t))
...
function Ca(t, e, { horizontal: i, minRotation: s }) {
  const n = Ht(s),
...
(Da.id = "category"),
  (Da.defaults = { ticks: { callback: Da.prototype.getLabelForValue } });
class Oa extends Vn {
  constructor(t) {
    super(t),
      (this.start = void 0),
  ...
  buildTicks() {
    ...
    return (
      "ticks" === t.bounds && Nt(s, this, "value"),
      t.reverse
  ...
  getLabelForValue(t) {
    return Qi(t, this.chart.options.locale);
  }
}
class Ta extends Oa {
  determineDataLimits() {
...
(Ta.id = "linear"),
  (Ta.defaults = { ticks: { callback: Tn.formatters.numeric } });
class La extends Vn {
  constructor(t) {
    super(t),
      (this.start = void 0),
    ...
    const t = this.options,
      e = (function (t, e) {
        const i = Math.floor(Ft(e.max)),
          ...
          n = [];
        let o = ut(t.min, Math.pow(10, Math.floor(Ft(e.min)))),
          a = Math.floor(Ft(o)),
          r = Math.floor(o / Math.pow(10, a)),
          l = a < 0 ? Math.pow(10, Math.abs(a)) : 1;
        do {
          n.push({ value: o, major: Aa(o) }),
            ++r,
            10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)),
            (o = Math.round(r * Math.pow(10, a) * l) / l);
        } while (a < i || (a === i && r < s));
        const h = ut(t.max, o);
        return n.push({ value: h, major: Aa(o) }), n;
      })({ min: this._userMin, max: this._userMax }, this);
    return (
      "ticks" === t.bounds && Nt(e, this, "value"),
      t.reverse
  ...
  getLabelForValue(t) {
    return void 0 === t ? "0" : Qi(t, this.chart.options.locale);
  }
  configure() {
    const t = this.min;
    super.configure(),
...
function Ra(t) {
  ...
  if (e.display && t.display) {
    const t = ai(e.backdropPadding);
    return ft(e.font && e.font.size, Be.font.size) + t.height;
  }
  return 0;
}
  ...
  for (let h = 0; h < o; h++) {
    ...
    const c = t.getPointPosition(h, t.drawingArea + n[h]),
      ...
      u =
        ((a = t.ctx),
        (r = d),
        (l = ht((l = t._pointLabels[h])) ? l : [l]),
        { w: Ne(a, r.string, l), h: l.length * r.lineHeight });
    s[h] = u;
    const f = t.getIndexAngle(h),
      g = jt(f),
      p = Ea(g, c.x, u.w, 0, 180),
      m = Ea(g, c.y, u.h, 90, 270);
...
(La.id = "logarithmic"),
  (La.defaults = {
    ticks: { callback: Tn.formatters.logarithmic, major: { enabled: !0 } },
  });
class Wa extends Oa {
  constructor(t) {
    super(t),
  ...
  setDimensions() {
    (this.width = this.maxWidth),
      (this.height = this.maxHeight),
      (this.paddingTop = Ra(this.options) / 2),
  ...
  getIndexAngle(t) {
    return qt(
      t * (Tt / this.getLabels().length) + Ht(this.options.startAngle || 0)
    );
  }
  ...
  getPointLabelContext(t) {
    ...
    if (t >= 0 && t < e.length) {
      ...
      return (function (t, e, i) {
        return hi(t, { label: i, index: e, type: "pointLabel" });
      })(this.getContext(), t, i);
    }
  }
  getPointPosition(t, e) {
    const i = this.getIndexAngle(t) - Et;
    return {
      ...
      (e.pointLabels.display &&
        (function (t, e) {
          ...
          for (let n = e - 1; n >= 0; n--) {
            ...
            Ze(i, t._pointLabels[n], a, r + o.lineHeight / 2, o, {
              color: e.color,
              textAlign: l,
              textBaseline: "middle",
            });
  ...
  drawLabels() {
    ...
    t.save(),
      ...
      this.ticks.forEach((s, a) => {
        ...
        Ze(t, s.label, 0, -n, l, { color: r.color });
      }),
      t.restore();
  }
  drawTitle() {}
...
(Wa.id = "radialLinear"),
  (Wa.defaults = {
    ...
    grid: { circular: !1 },
    startAngle: 0,
    ticks: { showLabelBackdrop: !0, callback: Tn.formatters.numeric },
    pointLabels: {
  ...
  (Wa.descriptors = { angleLines: { _fallback: "grid" } });
const Na = {
...
function Ua(t, e, i, s) {
  const n = Ha.length;
  for (let o = Ha.indexOf(t); o < n - 1; ++o) {
    const t = Na[Ha[o]],
      n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
    if (t.common && Math.ceil((i - e) / (n * t.size)) <= s) return Ha[o];
  }
  return Ha[n - 1];
}
function Xa(t, e, i) {
...
class Ka extends Vn {
  ...
  init(t, e) {
    const i = t.time || (t.time = {}),
      s = (this._adapter = new Ys._date(t.adapters.date));
  ...
  parse(t, e) {
    return void 0 === t ? null : Ya(this, t);
  }
  beforeLayout() {
    ...
    return (
      (this._unit =
        ...
        (i.autoSkip
          ...
          : (function (t, e, i, s, n) {
              for (let o = Ha.length - 1; o >= Ha.indexOf(i); o--) {
                const i = Ha[o];
                if (Na[i].common && t._adapter.diff(n, s, i) >= e - 1) return i;
              }
              return Ha[i ? Ha.indexOf(i) : 0];
            })(this, o.length, e.minUnit, this.min, this.max))),
      (this._majorUnit =
        i.major.enabled && "year" !== this._unit
          ? (function (t) {
              for (let e = Ha.indexOf(t) + 1, i = Ha.length; e < i; ++e)
                if (Na[Ha[e]].common) return Ha[e];
            })(this._unit)
          : void 0),
      this.initOffsets(s),
      t.reverse && o.reverse(),
  ...
  _generate() {
    ...
    for (c = u, d = 0; c < i; c = +t.add(c, a, o), d++) Xa(h, c, f);
    return (
      (c !== i && "ticks" !== s.bounds && 1 !== d) || Xa(h, c, f),
      Object.keys(h)
        .sort((t, e) => t - e)
        .map((t) => +t)
    );
  ...
  _getLabelSize(t) {
    const e = this.options.ticks,
      ...
      s = Ht(this.isHorizontal() ? e.maxRotation : e.minRotation),
      n = Math.cos(s),
      o = Math.sin(s),
  ...
  getLabelTimestamps() {
    ...
    for (e = 0, i = s.length; e < i; ++e) t.push(Ya(this, s[e]));
...
function Ga(t, e, i) {
  let s,
    ...
    l = t.length - 1;
  i
    ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = di(t, "pos", e)),
      ({ pos: s, time: o } = t[r]),
      ({ pos: n, time: a } = t[l]))
    : (e >= t[r].time &&
        e <= t[l].time &&
        ({ lo: r, hi: l } = di(t, "time", e)),
      ({ time: s, pos: o } = t[r]),
      ({ time: n, pos: a } = t[l]));
  const h = n - s;
...
(Za.id = "timeseries"), (Za.defaults = Ka.defaults);
const Qa = [
  Ns,
  Fo,
  ka,
...
function tr(t, e, i) {
  ...
  return (
    u(() => {
      r = new co(s, { type: o, data: n, options: a });
    }),
    L(() => {
      r && ((r.data = n), (r.type = o), (r.options = a), r.update());
    }),
    R(() => {
      r = null;
    }),
...
class er extends t {
  constructor(t) {
    super(), e(this, t, tr, Ja, i, { data: 2, type: 3, options: 4 });
  }
}
function ir(t) {
  let e, i;
...
function or(t) {
  ...
  return (
    ...
    {
      c() {
        (e = s("h2")), (i = g(b)), (l = p()), M(c.$$.fragment);
      },
      l(t) {
        e = n(t, "H2", {});
        var s = o(e);
        (i = m(s, b)), s.forEach(a), (l = x(t)), k(c.$$.fragment, t);
      },
      m(t, s) {
...
class fr extends t {
  constructor(t) {
    super(), e(this, t, ur, cr, i, { slug: 0 });
  }
}
export { fr as default, dr as preload };
