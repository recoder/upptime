import {
  ...
  X as F,
  Y as $,
} from "./client.979ca2b1.js";
import { h as V, L as B, c as W, a as N } from "./createOctokit.56eb06fb.js";
function H(t) {
  let e,
    i,
    l,
...
function nr(t, e, i) {
  ...
  return (
    u(() => {
      r = new po(s, { type: o, data: n, options: a });
    }),
    L(() => {
...
class or extends t {
  constructor(t) {
    super(), e(this, t, nr, sr, i, { data: 2, type: 3, options: 4 });
  }
}
function ar(t) {
  let e, i;
