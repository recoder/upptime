...
import {
  ...
  a as tt,
  b as et,
} from "./createOctokit.5db77836.js";
function it(t) {
  var n = (function () {
...
function nt(t) {
  ...
  return {
    ...
    l: function (t) {
      ...
      var w = c(x);
      (R = M(w, B)), w.forEach(f), (T = h(d, "DD", {}));
      var D = c(T);
      (L = M(D, W)), (E = M(D, j)), D.forEach(f), d.forEach(f), this.h();
    },
    h: function () {
...
function dt(t) {
  var e,
    ...
    R = _.i18n.incidentReport.replace(/\$NUMBER/g, t[6].number) + "",
    T = t[6].showHeading && ft(t);
  return {
    c: function () {
      T && T.c(),
        (e = w()),
    ...
    l: function (t) {
      T && T.l(t), (e = S(t)), (i = h(t, "ARTICLE", { class: !0 }));
      var u = c(i);
      n = h(u, "DIV", { class: !0 });
      var d = c(n);
      a = h(d, "DIV", {});
...
function Ht(t, e) {
  if ("" === e) return t;
  for (var i = 0, n = Nt(e, i); t && n > i; )
    (t = t[e.substr(i, n - i)]), (n = Nt(e, (i = n + 1)));
  return t;
}
function $t(t) {
...
var ye = function (t) {
  ...
  _e = {
    ...
    easeInSine: function (t) {
      return 1 - Math.cos(t * Qt);
    },
    easeOutSine: function (t) {
      return Math.sin(t * Qt);
    },
    ...
    easeInElastic: function (t) {
      return ye(t) ? t : be(t, 0.075, 0.3);
    },
    easeOutElastic: function (t) {
      return ye(t) ? t : xe(t, 0.075, 0.3);
    },
...
function Pe(t) {
  var e = (function (t) {
    return De(t.r) && De(t.g) && De(t.b) && De(t.a);
  })(t)
    ? Me
    : Se;
...
function Ae(t) {
  return Ce(Oe(2.55 * t), 0, 255);
}
function Re(t) {
  return Ce(Oe(255 * t), 0, 255);
}
function Te(t) {
  return Ce(Oe(t / 2.55) / 100, 0, 1);
}
function Le(t) {
  return Ce(Oe(100 * t), 0, 100);
}
var Ee = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
var Ie = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
function ze(t, e, i) {
    ...
    (($e = (function () {
      ...
      for (t = 0; t < o.length; t++) {
        for (n = a = o[t], e = 0; e < s.length; e++)
          (i = s[e]), (a = a.replace(i, Ue[i]));
        (i = parseInt(Ye[n], 16)),
          (r[a] = [(i >> 16) & 255, (i >> 8) & 255, 255 & i]);
      }
      return r;
    })()).transparent = [0, 0, 0, 0]);
  var e = $e[t.toLowerCase()];
  ...
  return (
    Array.isArray(t)
      ? t.length >= 3 &&
        ...
        t.length > 3 && (e.a = Re(t[3])))
      : ((e = Ke(t, { r: 0, g: 0, b: 0, a: 1 })).a = Re(e.a)),
    e
  );
}
function Ze(t) {
  ...
  return (
    s(t, [
      ...
      },
      {
        key: "hexString",
        value: function () {
          return this._valid ? Pe(this._rgb) : this._rgb;
        },
      },
      {
        key: "hslString",
      ...
      },
      {
        ...
        value: function () {
          var t = this._rgb,
            e = Oe(0.3 * t.r + 0.59 * t.g + 0.11 * t.b);
...
function ii(t) {
  return ti(t) ? t : Qe(t).saturate(0.5).darken(0.1).hexString();
}
...
function oi(t, e, i) {
  return "string" == typeof e ? Bt(ri(t, e), i) : Bt(ri(t, ""), e);
}
var si = (function () {
    function t(e) {
      n(this, t),
        ...
        (this.hoverBackgroundColor = function (t, e) {
          return ii(e.backgroundColor);
        }),
        (this.hoverBorderColor = function (t, e) {
          return ii(e.borderColor);
        }),
            ...
            Object.defineProperties(
              ...
              et(a, e, {
                ...
                get: function () {
                  var t = this[s],
                    e = o[n];
                  return Ot(t) ? Object.assign({}, e, t) : Rt(t, e);
                },
                set: function (t) {
                  this[s] = t;
                },
...
function hi(t, e, i, n) {
  ...
  var o,
    ...
    f = i.length;
  for (o = 0; o < f; o++)
    if (null != (u = i[o]) && !0 !== Pt(u)) c = ui(t, a, r, c, u);
    else if (Pt(u))
      for (s = 0, l = u.length; s < l; s++)
        null == (h = u[s]) || Pt(h) || (c = ui(t, a, r, c, h));
  t.restore();
  var d = r.length / 2;
  if (d > i.length) {
    ...
    switch ((t.beginPath(), u)) {
      ...
      case "rectRounded":
        (s = c - (l = 0.516 * c)),
          (r = Math.cos(f + te) * s),
          (o = Math.sin(f + te) * s),
          t.arc(i - r, n - o, l, f - qt, f - Qt),
          t.arc(i + o, n - r, l, f - Qt, f),
          t.arc(i + r, n + o, l, f, f + Qt),
          t.arc(i - o, n + r, l, f + Qt, f + qt),
          t.closePath();
        break;
      case "rect":
        if (!h) {
...
function bi(t, e, i, n, a) {
  var r,
    o,
    s = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {},
    l = Pt(e) ? e : [e],
    u = s.strokeWidth > 0 && "" !== s.strokeColor;
  for (t.save(), t.font = a.string, xi(t, s), r = 0; r < l.length; ++r)
    (o = l[r]),
      u &&
...
function ki(t, e) {
  var i = e.x,
    ...
    r = e.h,
    o = e.radius;
  t.arc(i + o.topLeft, n + o.topLeft, o.topLeft, -Qt, qt, !0),
    t.lineTo(i, n + r - o.bottomLeft),
    t.arc(i + o.bottomLeft, n + r - o.bottomLeft, o.bottomLeft, qt, Qt, !0),
    ...
    t.arc(i + a - o.topRight, n + o.topRight, o.topRight, 0, -Qt, !0),
    t.lineTo(i + o.topLeft, n);
}
var wi = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
  Mi = new RegExp(
...
function Pi(t) {
  return Di(t, { top: "y", right: "x", bottom: "y", left: "x" });
}
function Oi(t) {
  return Di(t, ["topLeft", "topRight", "bottomLeft", "bottomRight"]);
}
function Ci(t) {
  var e = Pi(t);
...
function Ai(t, e) {
  (t = t || {}), (e = e || li.font);
  var i = Rt(t.size, e.size);
  "string" == typeof i && (i = parseInt(i, 10));
  var n = Rt(t.style, e.style);
  n &&
    !("" + n).match(Mi) &&
    (console.warn('Invalid font style specified: "' + n + '"'), (n = ""));
  var a = {
    family: Rt(t.family, e.family),
    lineHeight: Si(Rt(t.lineHeight, e.lineHeight), i),
    size: i,
    style: n,
    weight: Rt(t.weight, e.weight),
    string: "",
  };
  return (
    (a.string = (function (t) {
...
var zi = ["push", "pop", "shift", "splice", "unshift"];
function Fi(t, e) {
  var i = t._chartjs;
  if (i) {
    var n = i.listeners,
          ...
          Pt(s) &&
            ...
            (s = (function (t, e, i, n) {
              ...
              if (Ut(r.index) && n(t)) e = e[r.index % e.length];
                ...
                try {
                  for (c.s(); !(h = c.n()).done; ) {
                    var f = qi(u, a, t, h.value);
                    e.push(Wi(f, r, o && o[t], s));
                  }
                } catch (t) {
                  c.e(t);
                } finally {
...
function Xi(t, e, i, n, a) {
  ...
  try {
    for (o.s(); !(r = o.n()).done; ) {
      ...
      if (l) {
        t.add(l);
        var u = Ui(l._fallback, i, a);
        if (Ut(u) && u !== i && u !== n) return u;
      } else if (!1 === l && Ut(n) && i !== n) return null;
    }
  } catch (t) {
    o.e(t);
  } finally {
...
function qi(t, e, i, n) {
  var a = e._rootScopes,
    r = Ui(e._fallback, i, n),
    o = [].concat(V(t), V(a)),
    s = new Set();
  s.add(n);
  var l = Ki(s, o, i, r || i, n);
  return (
    null !== l &&
    (!Ut(r) || r === i || null !== (l = Ki(s, o, r, l, n))) &&
    Bi(Array.from(s), [""], a, r, function () {
      return (function (t, e, i) {
        var n = t._getTarget();
        e in n || (n[e] = {});
        var a = n[e];
...
function Ki(t, e, i, n, a) {
  for (; i; ) i = Xi(t, e, i, n, a);
  return i;
}
function Gi(t, e, i, n) {
  var a,
  ...
  try {
    for (o.s(); !(r = o.n()).done; ) {
      var s = r.value;
      if (((a = Zi(Ni(s, t), i)), Ut(a))) return Hi(t, a) ? qi(i, n, t, a) : a;
    }
  } catch (t) {
    o.e(t);
  } finally {
...
function nn(t, e, i) {
  for (var n, a, r, o, s, l = t.length, u = tn(t, 0), h = 0; h < l - 1; ++h)
    (s = u),
      (u = tn(t, h + 1)),
      s &&
        u &&
      ...
      for (i = 0, n = t.length; i < n; ++i)
        (o = r),
          ...
          r &&
            ((a = t[i]),
            o &&
              ((a.cp1x = rn(a.cp1x, e.left, e.right)),
              (a.cp1y = rn(a.cp1y, e.top, e.bottom))),
            s &&
              ((a.cp2x = rn(a.cp2x, e.left, e.right)),
              (a.cp2y = rn(a.cp2y, e.top, e.bottom))));
    })(t, i);
}
function sn() {
...
function gn(t, e, i, n) {
  var a = hn(t),
    r = fn(a, "margin"),
    o = un(a.maxWidth, t, "clientWidth") || Zt,
    s = un(a.maxHeight, t, "clientHeight") || Zt,
    l = (function (t, e, i) {
      var n, a;
      if (void 0 === e || void 0 === i) {
        ...
        if (r) {
          ...
          (e = o.width - u.width - l.width),
            ...
            (n = un(s.maxWidth, r, "clientWidth")),
            (a = un(s.maxHeight, r, "clientHeight"));
  ...
  return (
    ...
    (u = vn(Math.min(u, o, l.maxWidth))),
    (h = vn(Math.min(h, s, l.maxHeight))),
    u && !h && (h = vn(u / 2)),
    { width: u, height: h }
  );
}
...
function wn(t, e, i) {
  return (function (t, e) {
    ...
    var i = t + JSON.stringify(e),
      n = kn.get(i);
    return n || ((n = new Intl.NumberFormat(t, e)), kn.set(i, n)), n;
  })(e, i).format(t);
}
function Mn(t, e, i) {
  return t
...
function Pn(t) {
  return "angle" === t
    ? { between: ge, compare: de, normalize: ve }
    : {
        between: me,
  ...
  for (
    ...
    (a = e[M % u]).skip ||
      ((n = d(a[o])) !== r &&
        ...
        null !== _ &&
          w() &&
          (b.push(On({ start: _, end: M, loop: m, count: u, style: y })),
          (_ = null)),
        (S = M),
        (r = n)));
  return (
    null !== _ && b.push(On({ start: _, end: p, loop: m, count: u, style: y })),
    b
  );
}
function An(t, e) {
  for (var i = [], n = t.segments, a = 0; a < n.length; a++) {
    var r = Cn(n[a], t.points, e);
...
function In(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? En(Object(i), !0).forEach(function (e) {
          et(t, e, i[e]);
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i))
      : En(Object(i)).forEach(function (e) {
...
var Bn = new ((function () {
  ...
  Wn = {
    ...
    color: function (t, e, i) {
      var n = ei(t || "transparent"),
        a = n.valid && ei(e || "transparent");
  ...
  jn = (function () {
    function t(e, i, a, r) {
      n(this, t);
      var o = i[a];
      r = Ri([e.to, r, o, e.from]);
      var s = Ri([e.from, o, r]);
      (this._active = !0),
        (this._fn = e.fn || Wn[e.type || F(s)]),
        (this._easing = _e[e.easing] || _e.linear),
          ...
          value: function (t, e, i) {
            if (this._active) {
              ...
              (this._start = i),
                ...
                (this._total += a),
                (this._loop = !!t.loop),
                (this._to = Ri([t.to, e, n, t.from])),
                (this._from = Ri([t.from, n, e]));
            }
          },
        },
        {
...
var Nn = Object.keys(li.animation);
li.describe("animation", {
  _fallback: !1,
  _indexable: !1,
  _scriptable: function (t) {
  ...
  li.describe("animations", { _fallback: "animation" }),
  li.set("transitions", {
...
function Kn(t, e, i, n) {
  var a,
    r = Fn(e.getMatchingVisibleMetas(n).reverse());
  try {
    for (r.s(); !(a = r.n()).done; ) {
      var o = a.value,
        s = t[o.index];
...
function Gn(t, e) {
  for (
    ...
    var v = e[d],
      g = v[u],
      p = v[h];
    ((i = (v._stacks || (v._stacks = {}))[h] = qn(r, c, g))[l] = p),
      (i._top = Kn(i, s, !0, a.type)),
      (i._bottom = Kn(i, s, !1, a.type));
  }
}
function Zn(t, e) {
  var i = t.scales;
    ...
    return (
      s(t, [
        ...
        },
        {
          ...
          value: function () {
            var t = this.chart,
              ...
              a = (e.xAxisID = Rt(i.xAxisID, Zn(t, "x"))),
              r = (e.yAxisID = Rt(i.yAxisID, Zn(t, "y"))),
              o = (e.rAxisID = Rt(i.rAxisID, Zn(t, "r"))),
              s = e.indexAxis,
        ...
        },
        {
          ...
          value: function () {
            var t = this._cachedMeta;
            this._data && Fi(this._data, this), t._stacked && Jn(t);
          },
        },
        {
          key: "_dataCheck",
        ...
        },
        {
          ...
          value: function (t) {
            ...
            (e._stacked = Xn(e.vScale, e)),
              e.stack !== i.stack && ((n = !0), Jn(e), (e.stack = i.stack)),
              this._resyncElements(t),
              (n || a !== e._stacked) && Gn(this, e._parsed);
          },
        },
        {
          key: "configure",
        ...
        },
        {
          ...
          value: function (t, e, i, n) {
            ...
            n && o && ((n.values = o), (r = Yn(n, a, this._cachedMeta.index))),
            ...
            var i,
              ...
              u = (function (t, e, i) {
                return (
                  t &&
                  !e.hidden &&
                  e._stacked && { keys: Un(i, !0), values: null }
                );
              })(e, a, this.chart),
              h = {
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var u = this.chart.config,
              ...
              d = Object.keys(li.elements[t]),
              v = function () {
                return e.getContext(n, a);
              },
              g = u.resolveNamedOptions(f, d, v, c);
            return (
              g.$shared && ((g.$shared = l), (r[o] = Object.freeze(ta(g, l)))),
              g
            );
          },
        },
...
(ea.defaults = {}),
  (ea.prototype.datasetElementType = null),
  (ea.prototype.dataElementType = null);
var ha = (function (i) {
  t(r, ea);
  var a = zn(r);
  function r() {
          ...
          for (var d = e; d < e + i; d++) {
            var v = this.getParsed(d),
              ...
              y = {
                ...
                base: g.base,
                enableBorderRadius:
                  !m || ra(v._custom) || r === m._top || r === m._bottom,
                x: l ? g.head : p.center,
                y: l ? p.center : g.head,
            ...
            f = (function (t, e, i) {
              ...
              if (e < Kt) {
                var s = t,
                  ...
                  f = Math.sin(l),
                  d = function (t, e, n) {
                    return ge(t, s, l, !0) ? 1 : Math.max(e, e * i, n, n * i);
                  },
                  v = function (t, e, n) {
                    return ge(t, s, l, !0) ? -1 : Math.min(e, e * i, n, n * i);
                  },
                  g = d(0, u, c),
                  p = d(Qt, h, f),
                  m = v(qt, u, c),
      ...
      },
      {
        ...
        value: function (t) {
          var e = this._cachedMeta,
            i = this.chart,
            n = i.data.labels || [],
            a = wn(e._parsed[t], i.options.locale);
              ...
              if (t._sorted) {
                ...
                f &&
                  (a = pe(
                    Math.min(
                      Ei(s, o.axis, h).lo,
                      i ? n : Ei(e, l, o.getPixelForValue(h)).lo
                    ),
                    0,
                    n - 1
                  )),
                  (r = d
                    ? pe(
                        Math.max(
                          Ei(s, o.axis, c).hi + 1,
                          i ? 0 : Ei(e, l, o.getPixelForValue(c)).hi + 1
                        ),
                        a,
                        n
                      ) - a
    ...
    s(a, [
      {
        ...
        value: function (t) {
          var e = this._cachedMeta,
            i = this.chart,
            n = i.data.labels || [],
            a = wn(e._parsed[t].r, i.options.locale);
          return { label: n[t] || "", value: a };
        },
      },
      {
...
(pa.id = "radar"),
  ...
  (pa.overrides = { aspectRatio: 1, scales: { r: { type: "radialLinear" } } });
var ma = (function (e) {
  t(a, da);
  var i = zn(a);
  function a() {
...
xa.override = function (t) {
  Object.assign(xa.prototype, t);
};
var _a = { _date: xa };
function ka(t, e) {
  return "native" in t ? { x: t.x, y: t.y } : dn(t, e);
}
function wa(t, e, i, n) {
  var a = t.controller,
    r = t.data,
...
function Sa(t, e, i, n) {
  var a = [];
  if (!vi(e, t.chartArea, t._minPadding)) return a;
  return (
    Ma(
      t,
      i,
...
function Da(t, e, i, n, a) {
  ...
  return (
    Ma(t, i, e, function (i, l, u) {
      var h = i.inRange(e.x, e.y, a);
      if (!n || h) {
        var c = i.getCenterPoint(a);
        if (vi(c, t.chartArea, t._minPadding) || h) {
          var f = o(e, c);
          f < s
            ? ((r = [{ element: i, datasetIndex: l, index: u }]), (s = f))
            : f === s && r.push({ element: i, datasetIndex: l, index: u });
        }
      }
    }),
    r
...
function Pa(t, e, i, n, a) {
  return vi(e, t.chartArea, t._minPadding)
    ? "r" !== i || n
      ? Da(t, e, i, n, a)
      : (function (t, e, i, n) {
          var a = [];
          return (
            Ma(t, i, e, function (t, i, r) {
              var o = t.getProps(["startAngle", "endAngle"], n),
                s = o.startAngle,
                l = o.endAngle;
              ge(ce(t, { x: e.x, y: e.y }).angle, s, l) &&
                a.push({ element: t, datasetIndex: i, index: r });
            }),
            a
          );
...
var Ca = {
    modes: {
      index: function (t, e, i, n) {
        var a = ka(e, t),
          r = i.axis || "x",
          o = i.intersect ? Sa(t, a, r, n) : Pa(t, a, r, !1, n),
          s = [];
        return o.length
      ...
      point: function (t, e, i, n) {
        return Sa(t, ka(e, t), i.axis || "xy", n);
      },
      nearest: function (t, e, i, n) {
        return Pa(t, ka(e, t), i.axis || "xy", i.intersect, n);
      },
      x: function (t, e, i, n) {
        return Oa(t, e, { axis: "x", intersect: i.intersect }, n);
      },
      y: function (t, e, i, n) {
        return Oa(t, e, { axis: "y", intersect: i.intersect }, n);
      },
    },
  },
...
function Ta(t, e) {
  return t.filter(function (t) {
    return -1 === Aa.indexOf(t.pos) && t.box.axis === e;
  });
}
function La(t, e) {
...
function Fa(t, e, i, n) {
  ...
  r.getPadding && za(o, r.getPadding());
  var l = Math.max(0, e.outerWidth - Ia(o, t, "left", "right")),
    u = Math.max(0, e.outerHeight - Ia(o, t, "top", "bottom")),
    h = l !== t.w,
    c = u !== t.h;
  return (
    (t.w = l),
    ...
    for (l.s(); !(a = l.n()).done; ) {
      ...
      if (u.horizontal) {
        ...
        Ut(c.start) && (s = c.start),
          h.fullSize
            ? Wa(h, r.left, s, i.outerWidth - r.right - r.left, v)
            : Wa(h, e.left + c.placed, s, d, v),
          (c.start = s),
          (c.placed += d),
          (s = h.bottom);
      } else {
        ...
        Ut(c.start) && (o = c.start),
          h.fullSize
            ? Wa(h, o, r.top, p, i.outerHeight - r.bottom - r.top)
            : Wa(h, o, e.top + c.placed, p, g),
          (c.start = o),
          (c.placed += g),
          (o = h.right);
      }
...
var Na = function (t, e) {
  ...
  Ua = function (t, e, i, n) {
    if (t) {
      var a = Ci(t.options.layout.padding),
      ...
      Ba(s.fullSize, d, c, v),
        ...
        ja(s.leftAndTop, d, c, v),
        (d.x += d.w),
        (d.y += d.h),
        ja(s.rightAndBottom, d, c, v),
        (t.chartArea = {
          left: d.left,
          top: d.top,
          right: d.left + d.w,
...
var Ga = !!mn && { passive: !0 };
function Za(t, e, i) {
  t.canvas.removeEventListener(e, i, Ga);
}
function Ja(t, e) {
  var i,
    n = Fn(t);
  ...
  var n = t.canvas,
    a = new MutationObserver(function (t) {
      ...
      try {
        for (r.s(); !(e = r.n()).done; ) {
          var o = e.value;
          a = (a = a || Ja(o.addedNodes, n)) && !Ja(o.removedNodes, n);
        }
      } catch (t) {
        r.e(t);
      } finally {
  ...
  var n = t.canvas,
    a = new MutationObserver(function (t) {
      ...
      try {
        for (r.s(); !(e = r.n()).done; ) {
          var o = e.value;
          a = (a = a || Ja(o.removedNodes, n)) && !Ja(o.addedNodes, n);
        }
      } catch (t) {
        r.e(t);
      } finally {
...
function ar(t, e, i) {
  ...
  if (a) {
    ...
    return (
      o.observe(a),
      (function (t, e) {
        er.size || window.addEventListener("resize", nr), er.set(t, e);
      })(t, r),
      o
    );
  }
...
function rr(t, e, i) {
  i && i.disconnect(),
    "resize" === e &&
      (function (t) {
        er.delete(t), er.size || window.removeEventListener("resize", nr);
      })(t);
}
function or(t, e, i) {
  var n = t.canvas,
      ...
      },
      {
        ...
        value: function (t, e, i) {
          ...
          var n = t.$proxies || (t.$proxies = {}),
            a = { attach: Qa, detach: tr, resize: ar }[e] || or;
          n[e] = a(t, e, i);
        },
      },
      {
        ...
        value: function (t, e) {
          var i = t.$proxies || (t.$proxies = {}),
            n = i[e];
          n &&
            (({ attach: rr, detach: rr, resize: rr }[e] || Za)(t, e, n),
            (i[e] = void 0));
        },
      },
      {
...
(lr.defaults = {}), (lr.defaultRoutes = void 0);
var ur = {
  values: function (t) {
    return Pt(t) ? t : "" + t;
  },
  numeric: function (t, e, i) {
    ...
    return Object.assign(u, this.options.ticks.format), wn(t, a, u);
  },
  logarithmic: function (t, e, i) {
    if (0 === t) return "0";
    var n = t / Math.pow(10, Math.floor(ie(t)));
    return 1 === n || 2 === n || 5 === n ? ur.numeric.call(this, t, e, i) : "";
  },
};
var hr = { formatters: ur };
function cr(t, e) {
  ...
  if (r > 0) {
    ...
    for (fr(e, l, u, Dt(f) ? 0 : o - f, o), h = 0, c = r - 1; h < c; h++)
      fr(e, l, u, a[h], a[h + 1]);
    return fr(e, l, u, s, Dt(f) ? e.length : s + f), l;
  }
  return fr(e, l, u), l;
}
function fr(t, e, i, n, a) {
  var r,
    ...
    s,
    l = Rt(n, 0),
    u = Math.min(Rt(a, t.length), t.length),
    h = 0;
  for (
...
li.set("scale", {
  ...
  li.route("scale.ticks", "color", "", "color"),
  li.route("scale.grid", "color", "", "borderColor"),
  li.route("scale.grid", "borderColor", "", "borderColor"),
  li.route("scale.title", "color", "", "color"),
  li.describe("scale", {
    _fallback: !1,
    _scriptable: function (t) {
      return (
  ...
  li.describe("scales", { _fallback: "scale" }),
  li.describe("scale.ticks", {
    _scriptable: function (t) {
      ...
      s(a, [
        ...
        },
        {
          ...
          value: function (t, e, i) {
            ...
            this._convertTicksToLabels(l ? vr(this.ticks, s) : this.ticks),
              this.configure(),
          ...
          value: function () {
            ...
            if (
              ...
              var u = this._getLabelSizes(),
                h = u.widest.width,
                c = u.highest.height,
                f = pe(this.chart.width - h, 0, this.maxWidth);
              h + 6 > (t = n.offset ? this.maxWidth / r : f / (r - 1)) &&
                ...
                (e =
                  ...
                  pr(n.grid) -
                  a.padding -
                  mr(n.title, this.chart.options.font)),
                (i = Math.sqrt(h * h + c * c)),
                (l = ue(
                  Math.min(
                    Math.asin(pe((u.highest.height + 6) / t, -1, 1)),
                    Math.asin(pe(e / i, -1, 1)) - Math.asin(pe(c / i, -1, 1))
                  )
                )),
        ...
        },
        {
          ...
          value: function () {
            var t = { width: 0, height: 0 },
              ...
              s = this.isHorizontal();
            if (o) {
              var l = mr(a, e.options.font);
              if (
                (s
                  ? ((t.width = this.maxWidth), (t.height = pr(r) + l))
                  : ((t.height = this.maxHeight), (t.width = pr(r) + l)),
              ...
              if (
                ...
                if (Pt(r))
                  for (n = 0, a = r.length; n < a; ++n)
                    Dt((f = r[n])) ||
                      Pt(f) ||
                      ((h = ui(d, l.data, l.gc, h, f)), (c += u));
              } else (h = ui(d, l.data, l.gc, h, r)), (c = u);
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return pe(
              this._alignToPixels ? ci(this.chart, e, 0) : e,
              -32768,
              32767
            );
          },
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var R = Rt(g.ticks.maxTicksLimit, x),
              T = Math.max(1, Math.ceil(x / R));
            for (i = 0; i < x; i += T) {
              var L = p.setContext(this.getContext(i)),
                ...
                B = L.tickColor,
                W = L.tickBorderDash || [],
                j = L.tickBorderDashOffset;
              void 0 !== (n = gr(this, i, y)) &&
                ((a = ci(v, n, E)),
            ...
            if ("top" === v)
              ...
              if ("center" === v) r = (t.top + t.bottom) / 2 + w;
                ...
                var A = Object.keys(v)[0],
                  R = v[A];
                r = this.chart.scales[A].getPixelForValue(R) + w;
              }
              o = this._getXAxisLabelAlignment();
            } else if ("y" === f) {
              if ("center" === v) a = (t.left + t.right) / 2 - w;
              else if (Ot(v)) {
                var T = Object.keys(v)[0],
                  L = v[T];
                a = this.chart.scales[T].getPixelForValue(L);
              }
          ...
          value: function () {
            ...
            if (a) {
              var r,
                ...
                h = this._borderValue;
              this.isHorizontal()
                ? ((r = ci(t, this.left, a) - a / 2),
                  (o = ci(t, this.right, u) + u / 2),
                  (s = l = h))
                : ((s = ci(t, this.top, a) - a / 2),
                  (l = ci(t, this.bottom, u) + u / 2),
                  (r = o = h)),
                e.save(),
        ...
        },
        {
          ...
          value: function (t) {
            return Ai(this.options.ticks.setContext(this.getContext(t)).font);
          },
        },
        {
          key: "_maxDigits",
            ...
            return (
              a in n ||
                ...
                (function (t, e, i) {
                  ...
                  t.descriptors && li.describe(e, t.descriptors);
                })(t, r, e),
                this.override && li.override(t.id, t.overrides)),
              r
            );
          },
        },
        ...
        },
        {
          ...
          value: function (t) {
            ...
            i in e && delete e[i],
              n &&
                i in li[n] &&
                (delete li[n][i], this.override && delete ni[i]);
          },
        },
      ]),
      t
...
var _r = (function () {
    function t() {
      n(this, t),
        (this.controllers = new xr(ea, "datasets", !0)),
        (this.elements = new xr(lr, "elements")),
        (this.plugins = new xr(Object, "plugins")),
        (this.scales = new xr(br, "scales")),
    ...
    return (
      s(t, [
        ...
        },
        {
          ...
          value: function (t, e) {
            var i = t && t.config,
              n = Rt(i.options && i.options.plugins, {}),
              a = (function (t) {
                for (
                  var e = [], i = Object.keys(kr.plugins.items), n = 0;
                  n < i.length;
                  n++
                )
                  e.push(kr.getPlugin(i[n]));
              ...
              ? (function (t, e, i, n) {
                  for (
                    ...
                    var s = e[o],
                      l = Mr(i[s.id], n);
                    null !== l &&
                      a.push({ plugin: s, options: Sr(t.config, s, l, r) });
                  }
                  return a;
                })(t, a, n, e)
              : [];
...
function Or(t) {
  ...
  (e.plugins = Rt(e.plugins, {})),
    (e.scales = (function (t, e) {
      var i = ni[t.type] || { scales: {} },
        n = e.scales || {},
        a = Dr(t.type, e),
      ...
      return (
        ...
        Object.keys(o).forEach(function (t) {
          var e = o[t];
          Wt(e, [li.scales[e.type], li.scale]);
        }),
        o
      );
    })(t, e));
...
function Tr(t, e) {
  var i = Ar.get(t);
  return i || ((i = e()), Ar.set(t, i), Rr.add(i)), i;
}
    ...
    function t(e) {
      n(this, t),
        (this._config = (function (t) {
          return ((t = t || {}).data = Cr(t.data)), Or(t), t;
        })(e)),
    ...
    return (
      s(t, [
        ...
        },
        {
          ...
          value: function (t, e) {
            return Tr("".concat(t, ".transition.").concat(e), function () {
              return [
                [
        ...
        },
        {
          ...
          value: function (t, e) {
            return Tr("".concat(t, "-").concat(e), function () {
              return [
                [
        ...
        },
        {
          ...
          value: function (t) {
            var e = t.id,
              i = this.type;
            return Tr("".concat(i, "-plugin-").concat(e), function () {
              return [
        ...
        },
        {
          ...
          value: function () {
            var t = this.options,
              e = this.type;
            return [t, ni[e] || {}, li.datasets[e] || {}, { type: e }, li, ai];
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t, e) {
            var i =
              ...
              a = Ir(this._resolverCache, t, i),
              r = a.resolver;
            return Ot(e) ? Wi(r, e, void 0, n) : r;
          },
        },
      ]),
      t
  ...
  try {
    for (o.s(); !(i = o.n()).done; ) {
      var s = i.value,
        ...
        u = r(s),
        h = (u || l) && t[s];
      if ((l && (Yt(h) || zr(h))) || (u && Pt(h))) return !0;
    }
  } catch (t) {
    o.e(t);
  } finally {
...
var Vr = ["top", "bottom", "left", "right", "chartArea"];
function Br(t, e) {
  return "top" === t || "bottom" === t || (-1 === Vr.indexOf(t) && "x" === e);
}
function Wr(t, e) {
  return function (i, n) {
...
var Xr = (function () {
    function t(e, i) {
      ...
      (this.id = St()),
        ...
        ($r[this.id] = this),
        f && d
          ? (Bn.listen(this, "complete", jr),
            Bn.listen(this, "progress", Nr),
            this._initialize(),
      ...
      s(t, [
          ...
          value: function () {
            return (
              ...
              this.options.responsive
                ? this.resize()
                : pn(this, this.options.devicePixelRatio),
              this.bindEvents(),
            ...
            i &&
              ...
              Et(r, function (i) {
                var r = i.options,
                  ...
                  l = Rt(r.type, i.dtype);
                (void 0 !== r.position &&
                  Br(r.position, s) === Br(i.dposition)) ||
        ...
        },
        {
          ...
          value: function () {
            ...
            this._sortedMetasets = t.slice(0).sort(Wr("order", "index"));
          },
        },
        {
          ...
          value: function () {
            ...
            for (
              ...
              if (
                ...
                (r.type = o),
                (r.indexAxis = a.indexAxis || Dr(o, this.options)),
                (r.order = a.order || 0),
                (r.index = t),
                (r.label = "" + a.label),
                ...
                var s = kr.getController(o),
                  l = li.datasets[o],
                  u = l.datasetElementType,
                  h = l.dataElementType;
                Object.assign(s.prototype, {
                  dataElementType: kr.getElement(h),
                  datasetElementType: u && kr.getElement(u),
                }),
        ...
        },
        {
          ...
          value: function () {
            var t,
              ...
              i = Fn(this._getUniformDataChanges() || []);
            try {
              for (i.s(); !(t = i.n()).done; ) {
                var n = t.value,
                  a = n.method,
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (!1 !== this.notifyPlugins("beforeLayout", { cancelable: !0 })) {
              Ua(this, this.width, this.height, t);
          ...
          value: function (t, e) {
            var i = this,
              n = {
                ...
                replay: e,
                cancelable: !0,
                inChartArea: vi(t, this.chartArea, this._minPadding),
              },
              a = function (e) {
        ...
        },
        {
          ...
          value: function (t, e, i) {
            ...
            i &&
              ((this._lastEvent = null),
              Lt(r.onHover, [t, s, this], this),
              l && Lt(r.onClick, [t, s, this], this));
            var h = !It(s, a);
            return (
              (h || e) &&
  ...
  qr = function () {
    return Et(Xr.instances, function (t) {
...
function Kr(t, e, i) {
  ...
  t.beginPath(),
    ...
    l > a
      ...
      : t.arc(r, o, a, i + Qt, n - Qt),
    t.closePath(),
    t.clip();
}
function Gr(t, e, i, n) {
  var a = Di(t.options.borderRadius, [
      "outerStart",
      "outerEnd",
      "innerStart",
      "innerEnd",
    ...
    s = function (t) {
      ...
      return pe(t, 0, Math.min(r, e));
    };
  return {
    outerStart: s(a.outerStart),
    outerEnd: s(a.outerEnd),
    innerStart: pe(a.innerStart, 0, o),
    innerEnd: pe(a.innerEnd, 0, o),
  };
}
function Zr(t, e, i, n) {
  return { x: i + t * Math.cos(e), y: n + t * Math.sin(e) };
}
function Jr(t, e, i, n, a) {
  var r = e.x,
    o = e.y,
    s = e.startAngle,
    l = e.pixelMargin,
  ...
  if ((t.beginPath(), t.arc(r, o, h, S, D), x > 0)) {
    var R = Zr(M, D, r, o);
    t.arc(R.x, R.y, x, D, m + Qt);
  }
  var T = Zr(O, m, r, o);
  if ((t.lineTo(T.x, T.y), k > 0)) {
    var L = Zr(O, A, r, o);
    t.arc(L.x, L.y, k, m + Qt, A + Math.PI);
  }
  if ((t.arc(r, o, c, m - k / c, p + _ / c, !0), _ > 0)) {
    var E = Zr(P, C, r, o);
    t.arc(E.x, E.y, _, C + Math.PI, p - Qt);
  }
  var I = Zr(w, p, r, o);
  if ((t.lineTo(I.x, I.y), b > 0)) {
    var z = Zr(w, S, r, o);
    t.arc(z.x, z.y, b, p - Qt, S);
  }
  t.closePath();
}
function Qr(t, e, i, n, a) {
  var r = e.options,
    o = r.borderWidth,
    s = r.borderJoinStyle,
  ...
  o &&
    (l
      ? ((t.lineWidth = 2 * o), (t.lineJoin = s || "round"))
      : ((t.lineWidth = o), (t.lineJoin = s || "bevel")),
    e.fullCircles &&
      (function (t, e, i) {
        var n,
          a = e.x,
...
Object.defineProperties(Xr, {
  defaults: { enumerable: true, value: li },
  instances: { enumerable: true, value: $r },
  overrides: { enumerable: true, value: ni },
  registry: { enumerable: true, value: kr },
  version: { enumerable: true, value: "3.7.0" },
  getChart: { enumerable: true, value: Ur },
  register: {
    enumerable: true,
    value: function () {
      kr.add.apply(kr, arguments), qr();
    },
  },
  unregister: {
    enumerable: true,
    value: function () {
      kr.remove.apply(kr, arguments), qr();
    },
  },
});
var to = (function (e) {
    ...
    s(a, [
      {
        key: "inRange",
        value: function (t, e, i) {
          var n = ce(this.getProps(["x", "y"], i), { x: t, y: e }),
            a = n.angle,
            r = n.distance,
            o = this.getProps(
              [
        ...
        value: function (t) {
          ...
          if (
            ...
            var s = (function (t, e, i, n) {
              ...
              return Jr(t, e, i, n, s), t.fill(), s;
            })(t, this, r, a);
            Qr(t, this, r, a, s), t.restore();
          }
        },
      },
    ]),
...
function eo(t, e) {
  ...
  (t.lineCap = Rt(i.borderCapStyle, e.borderCapStyle)),
    t.setLineDash(Rt(i.borderDash, e.borderDash)),
    (t.lineDashOffset = Rt(i.borderDashOffset, e.borderDashOffset)),
    (t.lineJoin = Rt(i.borderJoinStyle, e.borderJoinStyle)),
    (t.lineWidth = Rt(i.borderWidth, e.borderWidth)),
    (t.strokeStyle = Rt(i.borderColor, e.borderColor));
}
function io(t, e, i) {
  t.lineTo(i.x, i.y);
}
    ...
    s(a, [
      {
        ...
        value: function (t, e) {
          ...
          if (
            ...
            on(this._points, i, t, n, e), (this._pointsUpdated = !0);
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t, e) {
          var i = this.options,
            n = t[e],
            a = this.points,
            r = An(this, { property: e, start: n, end: n });
          if (r.length) {
            var o,
              s,
              l = [],
      ...
      },
      {
        ...
        value: function (t, e, i, n) {
          ...
          (this.points || []).length &&
            a.borderWidth &&
            (t.save(), lo(t, this, i, n), t.restore()),
            this.animated &&
    ...
    s(a, [
      ...
      },
      {
        ...
        value: function (t, e) {
          ...
          this.skip ||
            i.radius < 0.1 ||
            !vi(this, e, this.size(i) / 2) ||
            ((t.strokeStyle = i.borderColor),
            (t.lineWidth = i.borderWidth),
            (t.fillStyle = i.backgroundColor),
            di(t, i, this.x, this.y));
        },
      },
      {
        key: "getRange",
  ...
  var e = fo(t),
    ...
    a = (function (t, e, i) {
      var n = t.options.borderWidth,
        ...
        r = Pi(n);
      return {
        t: vo(a.top, r.top, 0, i),
        r: vo(a.right, r.right, 0, e),
        b: vo(a.bottom, r.bottom, 0, i),
        l: vo(a.left, r.left, 0, e),
      };
    })(t, i / 2, n / 2),
    r = (function (t, e, i) {
      var n = t.getProps(["enableBorderRadius"]).enableBorderRadius,
        ...
        l = n || Ot(a);
      return {
        topLeft: vo(!l || s.top || s.left, r.topLeft, 0, o),
        topRight: vo(!l || s.top || s.right, r.topRight, 0, o),
        bottomLeft: vo(!l || s.bottom || s.left, r.bottomLeft, 0, o),
        bottomRight: vo(!l || s.bottom || s.right, r.bottomRight, 0, o),
      };
    })(t, i / 2, n / 2);
  return {
...
function po(t, e, i, n) {
  var a = null === e,
    r = null === i,
    o = t && !(a && r) && fo(t, n);
  return o && (a || me(e, o.left, o.right)) && (r || me(i, o.top, o.bottom));
}
function mo(t, e) {
  ...
  return (
    s(a, [
      ...
      },
      {
        key: "inXRange",
        value: function (t, e) {
          return po(this, t, null, e);
        },
      },
      {
        key: "inYRange",
        value: function (t, e) {
          return po(this, null, t, e);
        },
      },
      {
        key: "getCenterPoint",
    ...
    if (i.enabled) {
      ...
      t.data.datasets.forEach(function (e, a) {
        var r = e._data,
          ...
          l = r || e.data;
        if ("y" !== Ri([o, t.options.indexAxis]) && "line" === s.type) {
          ...
          if (
            ...
            var h = (function (t, e) {
                var i = e.length,
                  ...
                  u = r.maxDefined;
                return (
                  l && (n = pe(Ei(e, a.axis, o).lo, 0, i - 1)),
                  {
                    start: n,
                    count: u ? pe(Ei(e, a.axis, s).hi + 1, n, i) - n : i - n,
                  }
                );
              })(s, l),
              c = h.start,
              f = h.count;
            if (f <= (i.threshold || 4 * n)) _o(e);
            else {
              var d;
              switch (
                (Dt(r) &&
                    ...
                    for (a = e; a < e + i; ++a) {
                      ...
                      if (x === l)
                        ...
                        if (!Dt(u) && !Dt(h)) {
                          ...
                          k !== c &&
                            k !== _ &&
                            p.push(In(In({}, t[k]), {}, { x: v })),
                            w !== c &&
                              w !== _ &&
                              p.push(In(In({}, t[w]), {}, { x: v }));
                        }
                        a > 0 && _ !== c && p.push(t[_]),
                          p.push(r),
                          (l = x),
...
function Ao(t) {
  ...
  if ("stack" === i)
    return (function (t) {
      ...
      s.push(Ro({ x: null, y: e.bottom }, n));
      for (var l = 0; l < r.length; l++)
        for (var u = r[l], h = u.start; h <= u.end; h++) Oo(a, o[h], s);
      return new uo({ points: a, options: {} });
    })(t);
  if ("shape" === i) return !0;
  var a = Do(t);
  return a instanceof So ? a : Ro(a, n);
}
function Ro(t, e) {
  var i = [],
    n = !1;
  return (
    ...
    i.length
      ? new uo({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n })
      : null
  );
}
function To(t, e, i) {
          ...
          if (e.segments) {
            ...
            try {
              for (v.s(); !(d = v.n()).done; ) {
                var g,
                  p = d.value,
                  m = Eo(i, o[p.start], o[p.end], p.loop),
                  y = Fn(Cn(u, r, m));
                try {
                  for (y.s(); !(g = y.n()).done; ) {
                    var b = g.value;
                    s.push({
                      source: b,
                      target: p,
                      start: et({}, i, Io(f, m, "start", Math.max)),
                      end: et({}, i, Io(f, m, "end", Math.min)),
                    });
                  }
                } catch (t) {
                  y.e(t);
  ...
  try {
    for (u.s(); !(i = u.n()).done; ) {
      var h = i.value,
        ...
        m = void 0 === p ? o : p,
        y = !0 !== a;
      t.save(), (t.fillStyle = m), zo(t, s, y && Eo(r, d, v)), t.beginPath();
      var b = !!n.pathSegment(t, c),
        x = void 0;
      if (y) {
        b ? t.closePath() : Fo(t, a, v, r);
    ...
    (function (t, e) {
      ...
      t.save(),
        "x" === l &&
          r !== a &&
          (Lo(t, n, o.top),
          Vo(t, { line: i, target: n, color: a, scale: s, property: l }),
          t.restore(),
          t.save(),
          Lo(t, n, o.bottom)),
        Vo(t, { line: i, target: n, color: r, scale: s, property: l }),
        t.restore();
    })(t, {
      line: a,
      target: n,
...
var Wo = {
    ...
    afterDatasetsUpdate: function (t, e, i) {
      ...
      for (a = 0; a < s; ++a)
        (o = null),
          ...
          l.push(o);
      for (a = 0; a < s; ++a)
        (o = l[a]) && !1 !== o.fill && (o.fill = To(l, a, i.propagate));
    },
    beforeDraw: function (t, e, i) {
      for (
        ...
        var s = a[o].$filler;
        s && (s.line.updateControlPoints(r, s.axis), n && Bo(t.ctx, s, r));
      }
    },
      ...
      s(a, [
          ...
          value: function () {
            if (this.options.display) {
              var t = this._computeTitleHeight(),
                ...
                n = i.align,
                a = i.labels.padding,
                r = Mn(i.rtl, this.left, this.width);
              if (this.isHorizontal()) {
                var o,
                  s = 0,
        ...
        },
        {
          ...
          value: function () {
            var t,
              ...
              s = i.labels,
              l = li.color,
              u = Mn(i.rtl, this.left, this.width),
              h = Ai(s.font),
              c = s.color,
              f = s.padding,
              d = h.size,
              ...
              u.setWidth(e.width),
                ...
                (function (t, e, i) {
                  if (!(isNaN(p) || p <= 0 || isNaN(m) || m < 0)) {
                    r.save();
                    var n = Rt(i.lineWidth, 1);
                    if (
                      ((r.fillStyle = Rt(i.fillStyle, l)),
                      (r.lineCap = Rt(i.lineCap, "butt")),
                      (r.lineDashOffset = Rt(i.lineDashOffset, 0)),
                      (r.lineJoin = Rt(i.lineJoin, "miter")),
                      (r.lineWidth = n),
                      (r.strokeStyle = Rt(i.strokeStyle, l)),
                      r.setLineDash(Rt(i.lineDash, [])),
                      s.usePointStyle)
                    ) {
                      var a = {
        ...
        },
        {
          ...
          value: function () {
            ...
            if (e.display) {
              var a,
                r = Mn(t.rtl, this.left, this.width),
                o = this.ctx,
                s = e.position,
                l = i.size / 2,
                u = n.top + l,
          ...
          value: function (t, e) {
            ...
            if (me(t, this.left, this.right) && me(e, this.top, this.bottom))
              for (a = this.legendHitBoxes, i = 0; i < a.length; ++i)
                if (
                  me(t, (n = a[i]).left, n.left + n.width) &&
                  me(e, n.top, n.top + n.height)
                )
...
var Ho = {
    ...
    start: function (t, e, i) {
      var n = (t.legend = new No({ ctx: t.ctx, options: i, chart: t }));
      $a(t, n, i), Na(t, n);
    },
    stop: function (t) {
      Ha(t, t.legend), delete t.legend;
    },
      ...
      s(a, [
        {
          ...
          value: function (t, e) {
            ...
            if (((this.left = 0), (this.top = 0), i.display)) {
              ...
              this._padding = Ci(i.padding);
              var a = n * Ai(i.font).lineHeight + this._padding.height;
...
var Uo = {
    ...
    start: function (t, e, i) {
      !(function (t, e) {
        var i = new $o({ ctx: t.ctx, options: e, chart: t });
        $a(t, i, e), Na(t, i), (t.titleBlock = i);
      })(t, i);
    },
    stop: function (t) {
      var e = t.titleBlock;
      Ha(t, e), delete t.titleBlock;
    },
    beforeUpdate: function (t, e, i) {
      var n = t.titleBlock;
      $a(t, n, i), (n.options = i);
  ...
  Xo = {
    id: "subtitle",
    start: function (t, e, i) {
      var n = new $o({ ctx: t.ctx, options: i, chart: t });
      $a(t, n, i), Na(t, n), Yo.set(t, n);
    },
    stop: function (t) {
      Ha(t, Yo.get(t)), Yo.delete(t);
    },
    beforeUpdate: function (t, e, i) {
      var n = Yo.get(t);
      $a(t, n, i), (n.options = i);
...
function ts(t, e, i) {
  ...
  return { xAlign: i.xAlign || e.xAlign || Qo(t, e, i, n), yAlign: n };
}
function es(t, e, i, n) {
  var a = t.caretSize,
    r = t.caretPadding,
  ...
  return (
    ...
    { x: pe(g, 0, n.width - e.width), y: pe(p, 0, n.height - e.height) }
  );
}
function is(t, e, i) {
  var n = Ci(i.padding);
      ...
      },
      {
        ...
        value: function (t, e) {
          var i = e.callbacks,
            ...
            o = [];
          return (o = Ko(o, Go(n))), (o = Ko(o, Go(a))), (o = Ko(o, Go(r)));
        },
      },
      {
        key: "getBeforeBody",
          ...
          return (
            Et(t, function (t) {
              var e = { before: [], lines: [], after: [] },
                r = as(n, t);
              Ko(e.before, Go(r.beforeLabel.call(i, t))),
                Ko(e.lines, r.label.call(i, t)),
                Ko(e.after, Go(r.afterLabel.call(i, t))),
                a.push(e);
            }),
            a
          );
      ...
      },
      {
        ...
        value: function (t) {
          var e,
            ...
            l = [],
            u = [];
          for (e = 0, i = a.length; e < i; ++e) u.push(Zo(this.chart, a[e]));
          return (
            t.filter &&
      ...
      },
      {
        ...
        value: function (t, e) {
          var i,
            ...
            r = [];
          if (a.length) {
            var o = qo[n.position].call(this, a, this._eventPosition);
            ...
            var s = (this._size = Jo(this, n)),
              l = Object.assign({}, o, s),
              u = ts(this.chart, n, l),
              h = es(n, l, u, this.chart);
      ...
      },
      {
        ...
        value: function (t, e, i) {
          var n,
            ...
            s = o.length;
          if (s) {
            var l = Mn(i.rtl, this.x, this.width);
            for (
              t.x = is(this, i.titleAlign, i),
        ...
        value: function (t, e, i, n, a) {
          ...
          if (a.usePointStyle) {
            ...
            Object.values(x).some(function (t) {
              ...
              ? (t.beginPath(),
                (t.fillStyle = a.multiKeyBackground),
                ki(t, { x: y, y: v, w: l, h: s, radius: x }),
                t.fill(),
                t.stroke(),
                (t.fillStyle = r.backgroundColor),
                t.beginPath(),
                ki(t, { x: b, y: v + 1, w: l - 2, h: s - 2, radius: x }),
                t.fill())
              : ((t.fillStyle = a.multiKeyBackground),
                t.fillRect(y, v, l, s),
      ...
      },
      {
        ...
        value: function (t, e, i) {
          var n,
            ...
            o = r.length;
          if (o) {
            var s = Mn(i.rtl, this.x, this.width);
            for (
              t.x = is(this, i.footerAlign, i),
      ...
      },
      {
        ...
        value: function (t) {
          var e = this.chart,
            ...
            a = i && i.y;
          if (n || a) {
            var r = qo[t.position].call(
              this,
              this._active,
              this._eventPosition
            );
            if (!r) return;
            var o = (this._size = Jo(this, t)),
...
var os = {
    ...
    afterInit: function (t, e, i) {
      i && (t.tooltip = new rs({ chart: t, options: i }));
    },
    beforeUpdate: function (t, e, i) {
    ...
    s(r, [
      ...
      },
      {
        ...
        value: function (t, e) {
          ...
          return (function (t, e) {
            return null === t ? null : pe(Math.round(t), 0, e);
          })(
            (e =
              isFinite(e) && i[e] === t
                ? e
                : ls(i, t, Rt(e, t), this._addedLabels)),
            i.length - 1
          );
        },
      },
...
function hs(t, e) {
  ...
  for (
    ...
    (y && n !== f
      ? (u.push({ value: f }),
        n < f && C++,
        oe(Math.round((n + C * P) * i) / i, f, cs(f, D, t)) && C++)
      : n < f && C++);
    C < r;
    ++C
  )
  ...
  return (
    M && y && a !== d
      ? u.length && oe(u[u.length - 1].value, d, cs(d, D, t))
...
(us.id = "category"),
  (us.defaults = { ticks: { callback: us.prototype.getLabelForValue } });
var fs = (function (i) {
    t(r, br);
    var a = zn(r);
    function r(t) {
    ...
    return (
      s(r, [
        ...
        },
        {
          key: "getLabelForValue",
          value: function (t) {
            return wn(t, this.chart.options.locale, this.options.ticks.format);
          },
        },
      ]),
      r
...
(ds.id = "linear"),
  (ds.defaults = { ticks: { callback: hr.formatters.numeric } });
var gs = (function (i) {
  t(r, br);
  var a = zn(r);
  function r(t) {
    ...
    s(r, [
      {
        key: "parse",
        value: function (t, e) {
          var i = fs.prototype.parse.apply(this, [t, e]);
        ...
        value: function () {
          var t = this.options,
            e = (function (t, e) {
              ...
              do {
                a.push({ value: r, major: vs(r) }),
                  10 == ++s && ((s = 1), (l = ++o >= 0 ? 1 : l)),
                  (r = Math.round(s * Math.pow(10, o) * l) / l);
              } while (o < i || (o === i && s < n));
              var u = At(t.max, r);
              return a.push({ value: u, major: vs(r) }), a;
      ...
      },
      {
        ...
        value: function (t) {
          return void 0 === t
            ? "0"
            : wn(t, this.chart.options.locale, this.options.ticks.format);
        },
      },
      {
        key: "configure",
...
function ps(t) {
  ...
  if (e.display && t.display) {
    var i = Ci(e.backdropPadding);
    return Rt(e.font && e.font.size, li.font.size) + i.height;
  }
  return 0;
}
function ms(t, e, i, n, a) {
  return t === n || t === a
  ...
  for (
    ...
    var d = t.getPointPosition(c, t.drawingArea + s[c], h),
      ...
      g =
        ((e = t.ctx),
        (i = v),
        (n = Pt((n = t._pointLabels[c])) ? n : [n]),
        { w: hi(e, i.string, n), h: n.length * i.lineHeight });
    o[c] = g;
    var p = ve(t.getIndexAngle(c) + h),
      m = Math.round(ue(p));
    bs(r, a, p, ms(m, d.x, g.w, 0, 180), ms(m, d.y, g.h, 90, 270));
  }
    ...
    (t._pointLabelItems = (function (t, e, i) {
      for (
        var n = [],
          ...
          o = ps(r) / 2,
          s = t.drawingArea,
          l = r.pointLabels.centerPointLabels ? qt / a : 0,
          u = 0;
        u < a;
        u++
      ) {
        var h = t.getPointPosition(u, s + o + i[u], l),
          c = Math.round(ue(ve(h.angle + Qt))),
          f = e[u],
          d = ks(h.y, f.h, c),
          v = xs(c),
          g = _s(h.x, f.w, v);
...
function bs(t, e, i, n, a) {
  ...
  n.start < e.l
    ...
    : n.end > e.r && ((s = (n.end - e.r) / r), (t.r = Math.max(t.r, e.r + s))),
    a.start < e.t
...
(gs.id = "logarithmic"),
  (gs.defaults = {
    ticks: { callback: hr.formatters.logarithmic, major: { enabled: !0 } },
  });
var Ms = (function (e) {
  t(a, fs);
  var i = zn(a);
    ...
    s(a, [
      {
        key: "setDimensions",
        value: function () {
          var t = (this._padding = Ci(ps(this.options) / 2)),
      ...
      },
      {
        ...
        value: function (t) {
          var e = this;
          fs.prototype.generateTickLabels.call(this, t),
      ...
      },
      {
        ...
        value: function (t) {
          return ve(
            t * (Kt / (this._pointLabels.length || 1)) +
            ...
            (r.pointLabels.display &&
              (function (t, e) {
                for (
                  ...
                  bi(i, t._pointLabels[a], l, u + o.lineHeight / 2, o, {
                    color: r.color,
                    textAlign: h,
                    textBaseline: "middle",
                  });
            ...
            e.save(),
              ...
              this.ticks.forEach(function (o, s) {
                if (0 !== s || i.reverse) {
                  ...
                  bi(e, o.label, 0, -a, u, { color: l.color });
                }
              }),
              e.restore();
          }
...
(Ms.id = "radialLinear"),
  (Ms.defaults = {
    ...
    grid: { circular: !1 },
    startAngle: 0,
    ticks: { showLabelBackdrop: !0, callback: hr.formatters.numeric },
    pointLabels: {
  ...
  (Ms.descriptors = { angleLines: { _fallback: "grid" } });
var Ss = {
...
function Cs(t, e, i, n) {
  for (var a = Ds.length, r = Ds.indexOf(t); r < a - 1; ++r) {
    var o = Ss[Ds[r]],
      s = o.steps ? o.steps : Number.MAX_SAFE_INTEGER;
    if (o.common && Math.ceil((i - e) / (s * o.size)) <= n) return Ds[r];
  }
  return Ds[a - 1];
}
function As(t, e, i) {
    ...
    s(r, [
      {
        ...
        value: function (t, i) {
          var n = t.time || (t.time = {}),
            a = (this._adapter = new _a._date(t.adapters.date));
      ...
      },
      {
        key: "parse",
        value: function (t, e) {
          return void 0 === t ? null : Os(this, t);
        },
      },
      {
        key: "beforeLayout",
        ...
        value: function () {
          ...
          return (
            (this._unit =
              e.unit ||
              (i.autoSkip
                ? Cs(e.minUnit, this.min, this.max, this._getLabelCapacity(a))
                : (function (t, e, i, n, a) {
                    for (var r = Ds.length - 1; r >= Ds.indexOf(i); r--) {
                      var o = Ds[r];
                      if (Ss[o].common && t._adapter.diff(a, n, o) >= e - 1)
                        return o;
                    }
                    return Ds[i ? Ds.indexOf(i) : 0];
                  })(this, r.length, e.minUnit, this.min, this.max))),
            (this._majorUnit =
              i.major.enabled && "year" !== this._unit
                ? (function (t) {
                    for (var e = Ds.indexOf(t) + 1, i = Ds.length; e < i; ++e)
                      if (Ss[Ds[e]].common) return Ds[e];
                  })(this._unit)
                : void 0),
            this.initOffsets(n),
            t.reverse && r.reverse(),
            Rs(this, r, this._majorUnit)
          );
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t,
            ...
            r = this.options,
            o = r.time,
            s = o.unit || Cs(o.minUnit, n, a, this._getLabelCapacity(n)),
            l = Rt(o.stepSize, 1),
          ...
          for (t = f, e = 0; t < a; t = +i.add(t, l, s), e++) As(c, t, d);
          return (
            (t !== a && "ticks" !== r.bounds && 1 !== e) || As(c, t, d),
            Object.keys(c)
              .sort(function (t, e) {
                return t - e;
              })
      ...
      },
      {
        ...
        value: function () {
          ...
          for (t = 0, e = n.length; t < e; ++t) i.push(Os(this, n[t]));
    ...
    s(r, [
      {
        ...
        value: function () {
          ...
          (this._minPos = Ls(i, this.min)),
            (this._tableRange = Ls(i, this.max) - this._minPos),
...
(Es.id = "timeseries"), (Es.defaults = Ts.defaults);
var Is = [
  ya,
  xo,
  ss,
...
function Vs(t, e, i) {
  ...
  return (
    b(function () {
      f = new Xr(n, { type: s, data: r, options: u, plugins: c });
    }),
    H(function () {
      f &&
        ((f.data = r),
...
var Bs = (function (e) {
  ...
  function u(t) {
    ...
    return (
      n(this, u),
      (e = i.call(this)),
      a(o(e), t, Vs, Fs, r, { data: 2, type: 3, options: 4, plugins: 5 }),
      e
    );
  }
  return s(u);
...
var Hs = (function (e) {
  ...
  function u(t) {
    var e;
    return n(this, u), (e = i.call(this)), a(o(e), t, Ns, js, r, {}), e;
  }
  return s(u);
})();
function $s(t) {
...
function Us(t) {
  ...
  return (
    ...
    {
      c: function () {
        (e = u("h2")), (i = k(o)), (n = w()), R(a.$$.fragment);
      },
      l: function (t) {
        e = h(t, "H2", {});
        var r = c(e);
        (i = M(r, o)), r.forEach(f), (n = S(t)), T(a.$$.fragment, t);
      },
      m: function (t, o) {
...
var Ks = (function (e) {
  ...
  function u(t) {
    var e;
    return (
      n(this, u), (e = i.call(this)), a(o(e), t, qs, Xs, r, { slug: 4 }), e
    );
  }
  return s(u);
})();
...
var el = (function (e) {
  ...
  function u(t) {
    var e;
    return (
      n(this, u), (e = i.call(this)), a(o(e), t, tl, Zs, r, { slug: 0 }), e
    );
  }
  return s(u);
})();
export { el as default, Js as preload };
