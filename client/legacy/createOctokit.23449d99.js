...
function R(e) {
  ...
  return {
    ...
    l: function (e) {
      ...
      var p = d(t);
      o = m(p, "g", { fill: !0, "fill-rule": !0 });
      var u = d(o);
      s = m(u, "g", { transform: !0, "stroke-width": !0 });
      var h = d(s);
      (n = m(h, "circle", { "stroke-opacity": !0, cx: !0, cy: !0, r: !0 })),
        d(n).forEach(g),
        (i = m(h, "path", { d: !0 }));
      var T = d(i);
      (a = m(T, "animateTransform", {
        attributeName: !0,
        type: !0,
        from: !0,
        to: !0,
    ...
    h: function () {
      h(n, "stroke-opacity", ".5"),
        h(n, "cx", "18"),
        h(n, "cy", "18"),
        h(n, "r", "18"),
        h(a, "attributeName", "transform"),
        h(a, "type", "rotate"),
        h(a, "from", "0 18 18"),
        h(a, "to", "360 18 18"),
        h(a, "dur", "1s"),
        h(a, "repeatCount", "indefinite"),
        h(i, "d", "M36 18c0-9.94-8.06-18-18-18"),
        h(s, "transform", "translate(1 1)"),
        h(s, "stroke-width", "2"),
        h(o, "fill", "none"),
        h(o, "fill-rule", "evenodd"),
        h(t, "width", "38"),
        h(t, "height", "38"),
        h(t, "xmlns", "http://www.w3.org/2000/svg"),
        h(t, "stroke", "#aaa"),
        h(t, "title", T.loading),
        h(t, "class", "svelte-68jxue"),
        h(r, "class", "loading svelte-68jxue");
    },
    m: function (e, c) {
      E(e, r, c), f(r, t), f(t, o), f(o, s), f(s, n), f(s, i), f(i, a);
    },
    p: b,
    i: b,
    o: b,
...
function D() {
  return "object" ===
    ("undefined" == typeof navigator ? "undefined" : w(navigator)) &&
    "userAgent" in navigator
    ? navigator.userAgent
    : "object" === ("undefined" == typeof process ? "undefined" : w(process)) &&
      "version" in process
    ? "Node.js/"
...
function pr(e) {
  var r = (function (e, r) {
    for (var t = {}, o = 0, s = Object.entries(r); o < s.length; o++)
      for (
        var n = _(s[o], 2), i = n[0], a = n[1], c = 0, p = Object.entries(a);
        c < p.length;
        c++
      ) {
        var u = _(p[c], 2),
          ...
          b = f[0],
          w = f[1],
          v = Object.assign({ method: b, url: w }, h);
        t[i] || (t[i] = {});
        var k = t[i];
        k[l] = T ? cr(e, i, l, v, T) : e.request.defaults(v);
      }
    return t;
  })(e, ar);
...
var ur = Ze.plugin(Ye, pr, sr).defaults({
  ...
  lr = (T["status-website"] || {}).apiBaseUrl,
  dr = T.userAgent,
  mr = function () {
    var e = "";
    return (
  ...
  gr = function (e) {
    "Bad credentials" === e.message
      ? (window.location.href = T.path + "/error")
      : (e.message || "").indexOf("rate limit exceeded") > -1
      ? (window.location.href = T.path + "/rate-limit-exceeded")
      : ((window.location.href = T.path + "/error"), console.log(e.message));
  },
  hr = (function () {
    var e = F(
      k.mark(function e(r, t) {
        var o, s, n;
        return k.wrap(
          function (e) {
            for (;;)
                  ...
                  if (
                    ...
                    !(
                      ...
                      ("localhost" === document.domain
                        ? T["status-website"].localhostCacheTime || 36e5
                        : T["status-website"].productionCacheTime || 12e4)
                    ))
                  ) {
                    e.next = 10;
                    break;
